...
const { validateSecEdgarIntakeCapture } = require('./intake');
...
const CONVERTER_DIGEST = 'c6b6a93315fad0bc3e65be699c71e2fea4d98111ba701f72f19dfb96dfb5c85a';
...
function decodeEntity(entity) {
  ...
  // Zero-width and bidi marks are REAL characters in the source document.
  // Canonical text stays faithful to the bytes; making "Section 3.1"
  // findable is a MATCHING concern (see zero-width-normalise.js), not a
  // decoding one. Deleting them here would make quotes stop reproducing
  // the document honestly and would shift every downstream byte offset.
