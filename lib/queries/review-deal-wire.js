...
function trimReviewDealForWire(reviewDeal) {
  ...
  // This is a transient display model. It is kept separate from cards so a
  // review flag cannot become canonical extraction data by round trip.
  if (Object.prototype.hasOwnProperty.call(reviewDeal, 'canonical_v2_termination_rights_review_rows')) {
    out.canonical_v2_termination_rights_review_rows = reviewDeal.canonical_v2_termination_rights_review_rows;
  }
  if (Object.prototype.hasOwnProperty.call(reviewDeal, 'canonical_v2_termination_rights_review_prompts')) {
    out.canonical_v2_termination_rights_review_prompts = reviewDeal.canonical_v2_termination_rights_review_prompts;
  }
  if (Object.prototype.hasOwnProperty.call(reviewDeal, 'canonical_v2_termination_rights_review_source_status')) {
    out.canonical_v2_termination_rights_review_source_status = reviewDeal.canonical_v2_termination_rights_review_source_status;
  }
  return out;
}
