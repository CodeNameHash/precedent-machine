...
const COLUMNS = [
  ...
  },
  {
    key: 'buyer',
    label: 'Buyer',
    accessor: (deal) => deal.buyer_display || null,
    sortable: true,
    filterable: true,
    filterType: 'enum',
  ...
  {
    key: 'law_firm',
    label: 'Law firm (either party)',
    accessor: (deal) => [...new Set([...(deal.advisors?.buyer_firms || []), ...(deal.advisors?.seller_firms || [])])].join(', ') || null,
    filterValues: (deal) => [...new Set([...(deal.advisors?.buyer_firms || []), ...(deal.advisors?.seller_firms || [])])],
    sortable: true,
    filterable: true,
    filterType: 'enum',
    defaultVisible: false,
  ...
  {
    key: 'lawyer',
    label: 'Lawyer (either party)',
    accessor: (deal) => [...new Set([...(deal.advisors?.buyer_lawyers || []), ...(deal.advisors?.seller_lawyers || [])])].join(', ') || null,
    filterValues: (deal) => [...new Set([...(deal.advisors?.buyer_lawyers || []), ...(deal.advisors?.seller_lawyers || [])])],
    sortable: true,
    filterable: true,
    filterType: 'enum',
    defaultVisible: false,
