/* ─────────────────────────────────────────────────────────────────────────
   ...
   lib/canonical-v2/open-world-promotion-gate.js. That module is NOT required
   from here: this file is imported by the review page, and the gate reads
   the filesystem — keep the growth hook discoverable by comment/path only.
...
// them as an open-world promotion threshold (DECISIONS.md §14). The deal-
// count gate lives in lib/canonical-v2/open-world-promotion-gate.js.
