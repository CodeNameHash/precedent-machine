...
// (REP-T-NOREP / REP-B-NOREP / REP-B-ANTIRELIANCE — retired 2026-08-02, see
// docs/superpowers/specs/2026-08-02-v1-reclassification-design.md — or
// their eight R3 element successors: REP-T-/REP-B- x NOOTHERREPS/
// NONRELIANCE/INDEPINVEST/FRAUDCARVEOUT) OR be embedded in a MISC-ENTIRE
// "Entire Agreement" section with no dedicated title (Metsera §9.07 pattern
// — see lib/parser-v2/extract.js's MISC block). This module scans EVERY
// provision regardless of type/code, so it is agnostic to which of those
// landing spots a given deal used.
//
