/* ─────────────────────────────────────────────────────────────────────────
   ...
   server-side ingestion backstop) and components/review/ConsiderationTables.js
   (buildEquityRows, client-side raw-text augment) so both instrument-mention
   scanners apply the SAME guard. CommonJS (consumed by both a plain-Node
   ingestion module and, via Next's CJS/ESM interop, a browser-bundled
   component — the same pattern already used for lib/taxonomy.js /
   lib/rubric.js).
   ───────────────────────────────────────────────────────────────────────── */
