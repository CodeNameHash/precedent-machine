...
const CANONICAL_CONDITIONS_B = [
  ...
  { label: 'Covenant Performance',            re: /covenants?\s+(?:performed|complied|compliance)|performance\s+of\s+covenants|(?:target|company)\s+covenant/i },
...
const CANONICAL_CONDITIONS_S = [
  ...
  { label: 'Covenant Performance (Parent)',   re: /covenants?\s+(?:performed|complied|compliance)|performance\s+of\s+covenants|(?:parent|acquir\w+)\s+covenant/i },
