...
const SCORE_FIELDS = {
  TERMINATION_FEE: ['terminationFeePercentEquityValue', 'reverseFeePercentage', 'tailFeeWindowMonths', 'interestOnLatePayment'],
  ...
  CONSIDERATION: [
    'considerationType', 'perShareAmount', 'cvrPresent', 'electionMechanicsPresent',
    'equityAwardTreatmentPresent',
  ],
  COVENANT_INTERIM_OPERATING: ['iocRestrictionPresent', 'iocEvidenceMechanicPresent'],
