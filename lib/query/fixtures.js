  ...
  return [
    {
      ...
      href: `/query/${kindToSlug('DEAL_COMPARE')}/adhoc?payload=${encodePayload({ deal_ids: ids.slice(0, 4), provision_types: ['CONSIDERATION', 'TERMINATION_FEE', 'COVENANT_NO_SOLICITATION'], highlight_deltas: true, included_field_groups: ['primary', 'qualifiers'] })}`,
    ...
    },
    {
      ...
      href: `/query/${kindToSlug('PROVISION_CROSS_CUT')}/adhoc?payload=${encodePayload({ provision_type: 'COVENANT_NO_SOLICITATION', provision_subtype: null, deal_ids: ids, columns: ['go_shop', 'fiduciary_out', 'matching_rights_days'], sort_by: 'deal_signing_date_desc' })}`,
    ...
    },
    {
      ...
      href: `/query/${kindToSlug('MARKET_RANGE')}/adhoc?payload=${encodePayload({ provision_type: 'TERMINATION_FEE', [FIELD_PATH]: 'fee_amount_percent', deal_filter: {}, chart_kind: 'HISTOGRAM' })}`,
    ...
    },
    {
      ...
      href: `/query/${kindToSlug('FILTER_THEN_LIST')}/adhoc?payload=${encodePayload({ filters: [{ provision_type: 'COVENANT_NO_SOLICITATION', field: 'go_shop', op: 'eq', value: true }], sort_by: 'deal_signing_date_desc', columns: ['deal_name', 'signing_date', 'consideration_type', 'total_deal_value'] })}`,
    ...
    },
    {
      ...
      href: `/query/${kindToSlug('DEAL_TO_MARKET')}/adhoc?payload=${encodePayload({ deal_id: first, comparison_set_filter: {}, provision_types: null })}`,
    ...
    },
    {
      ...
      href: `/query/${kindToSlug('MARKET_RANGE')}/adhoc?payload=${encodePayload({ provision_type: 'COVENANT_NO_SOLICITATION', [FIELD_PATH]: 'matching_rights_days', deal_filter: {}, chart_kind: 'HISTOGRAM' })}`,
