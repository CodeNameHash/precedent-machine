...
const OPERATOR_LABELS = {
  // Ben r6: "I HATE the 'equals' — too coder-like." Reads as "Force the
  // vote · is · Yes".
  eq: 'is',
  neq: 'is not',
  gt: 'more than',
...
function formatFilterValue(value) {
  ...
  // Enum slugs ("reasonably-likely-to-lead-to-superior") read as words in
  // the preview line, same humanization as the value dropdown shows.
  if (/^[a-z0-9]+(-[a-z0-9]+)+$/.test(s)) return humanizeKey(s);
  return s;
}
