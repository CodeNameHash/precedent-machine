...
// WP-3 (M4-02) normalizer badges: `_meta.version` on normalized-v1.json
// (bumped by lib/schema-shape/registry-version.js on every reconcile
// decision — see WP-4). Read through the same cached registry parse
