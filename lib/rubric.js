...
const CODES = {
  ...
  'IOC-PRESERVE': {
    type: 'IOC',
    label: 'Preservation of Business / Use of Efforts',
    description: 'Use commercially reasonable / reasonable best efforts to preserve business organization, retain employees, and maintain customer/supplier relationships',
    aliases: ['Preservation of Business', 'Use of Efforts', 'Reasonable Best Efforts'],
    frequency: 'universal',
    industries: [],
  },
  'IOC-NOACTION': {
...
const FEATURES = {
  ...
  //    to a more specific ANTI-* code). Order is canonical: Provision first,
  //    then the efforts standard (the single most important field), then the
  //    caps / limits on burden, then litigation/filing/other details. Code-
  //    specific overrides for ANTI-NOACTION, ANTI-FILING, ANTI-EFFORTS, and
  //    ANTI-BURDEN live below.
  ANTI: [
    {
      key: 'mainConcept',
      label: 'Provision',
