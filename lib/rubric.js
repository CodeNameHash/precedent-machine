...
const FEATURES = {
  ...
  'REP-T': [
    ...
    // ── P5 item 2: Extended per-rep detail keys surfaced in the Specific
    //    Features column (Environment, IP, ERISA, Tax, IT/Cyber, Litigation).
    //    All rolled-up render-only fields — no taxonomy lookup.
    { key: 'environmentalLawsList', label: 'Environmental laws referenced', type: 'list', scope: 'clause' },
    { key: 'environmentalPermitsHeld', label: 'Environmental permits held', type: 'list', scope: 'clause' },
    { key: 'environmentalLiabilities', label: 'Environmental liabilities (description)', type: 'text', scope: 'clause' },
    { key: 'hazardousMaterialsScope', label: 'Hazardous materials scope (description)', type: 'text', scope: 'clause' },
    { key: 'ipRegistrations', label: 'IP registrations (description / list)', type: 'list', scope: 'clause' },
    { key: 'ipLicensesIn', label: 'Inbound IP licenses', type: 'list', scope: 'clause' },
    { key: 'ipLicensesOut', label: 'Outbound IP licenses', type: 'list', scope: 'clause' },
    { key: 'ipInfringementClaims', label: 'IP infringement claims', type: 'text', scope: 'clause' },
    { key: 'ipTradeSecretsProtection', label: 'IP trade-secrets protection', type: 'text', scope: 'clause' },
    { key: 'erisaPlansListed', label: 'ERISA plans listed on schedule', type: 'boolean', scope: 'clause' },
    { key: 'erisaCompliance', label: 'ERISA compliance', type: 'text', scope: 'clause' },
    { key: 'erisaTitleIVPlans', label: 'ERISA Title IV plans present', type: 'boolean', scope: 'clause' },
    { key: 'erisaMultiemployer', label: 'Multiemployer plan participation', type: 'boolean', scope: 'clause' },
    { key: 'erisaParachutePayments', label: 'Parachute payments described', type: 'text', scope: 'clause' },
    { key: 'taxReturnsFiled', label: 'Tax returns filed (description)', type: 'text', scope: 'clause' },
    { key: 'taxAuditsPending', label: 'Tax audits pending', type: 'text', scope: 'clause' },
    { key: 'taxClosingAgreements', label: 'Tax closing agreements', type: 'text', scope: 'clause' },
    { key: 'taxNoNotices', label: 'No notices of tax deficiency', type: 'boolean', scope: 'clause' },
    { key: 'taxSection355', label: 'Section 355 / spin-off treatment', type: 'text', scope: 'clause' },
    { key: 'taxAttributes', label: 'Tax attributes (NOLs, credits)', type: 'text', scope: 'clause' },
    { key: 'itSystemsScope', label: 'IT-systems scope', type: 'text', scope: 'clause' },
    { key: 'cybersecurityIncidents', label: 'Cybersecurity incidents', type: 'text', scope: 'clause' },
    { key: 'dataPrivacyCompliance', label: 'Data-privacy compliance', type: 'text', scope: 'clause' },
    { key: 'personalInfoBreaches', label: 'Personal-info breaches', type: 'text', scope: 'clause' },
    { key: 'pendingLitigation', label: 'Pending litigation', type: 'text', scope: 'clause' },
    { key: 'governmentInvestigations', label: 'Government investigations', type: 'text', scope: 'clause' },
    { key: 'outstandingOrders', label: 'Outstanding orders / judgments', type: 'text', scope: 'clause' },
  ],
...
const CITABLE_FEATURE_KEYS = new Set([
  ...
  // P5 item 2: extended per-rep detail keys (Environment, IP, ERISA, Tax,
  // IT/Cyber, Litigation). All marked citable so evidence quotes flow.
  'environmentalLawsList', 'environmentalPermitsHeld', 'environmentalLiabilities',
  'hazardousMaterialsScope',
  'ipRegistrations', 'ipLicensesIn', 'ipLicensesOut', 'ipInfringementClaims',
  'ipTradeSecretsProtection',
  'erisaPlansListed', 'erisaCompliance', 'erisaTitleIVPlans', 'erisaMultiemployer',
  'erisaParachutePayments',
  'taxReturnsFiled', 'taxAuditsPending', 'taxClosingAgreements', 'taxNoNotices',
  'taxSection355', 'taxAttributes',
  'itSystemsScope', 'cybersecurityIncidents', 'dataPrivacyCompliance',
  'personalInfoBreaches',
  'pendingLitigation', 'governmentInvestigations', 'outstandingOrders',
...
function getFeaturesForType(typeKey, code) {
  if (code && FEATURES[code]) return FEATURES[code];
