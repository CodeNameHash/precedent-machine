...
const FEATURES = {
  ...
  'REP-T': [
    ...
    // ── Stage 1: per-rep fundamental flag + SEC-filings exception detail ──
    { key: 'fundamentalRep', label: 'Fundamental rep (e.g. Capitalization, Authority)', type: 'boolean', scope: 'clause' },
  ...
  'REP-B': [
    ...
    { key: 'fundamentalRep', label: 'Fundamental rep (parent side, e.g. Authority, Organization)', type: 'boolean', scope: 'clause' },
