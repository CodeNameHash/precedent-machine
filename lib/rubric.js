...
const FEATURES = {
  ...
  'STRUCT-MERGER': [
    { key: 'mainConcept', label: 'Provision', type: 'text' },
    { key: 'mergerForm', label: 'Merger Form (ONE short phrase, e.g. "Reverse triangular merger")', type: 'text' },
  ],
  ...
  'COV-EMPLOYEE': [
    ...
    },
    {
      ...
      label: 'Compensation & Benefits Standards — array of { item, item_label, standard_code, standard_label, text } objects, one per comp/benefit item the provision addresses. Each item gets its OWN standard — do NOT collapse to a single section-wide standard.',
      type: 'list-tagged',
      description: 'Array of { item, standard_code, standard_label, text } — each comp/benefit item with its specific standard',
    },
    {
