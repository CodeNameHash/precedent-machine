...
const FEATURES = {
  ...
  NOSOL: [
    ...
    // Coded strength+party sibling to the forceTheVote boolean (which stays for
    // backward compatibility). Codebook: FORCE_THE_VOTE in lib/taxonomy.js.
    // Two axes: strength (HARD/SOFT — does the obligated party have a
    // self-termination-for-Superior escape?) and party (TARGET/ACQUIRER/BOTH —
    // whose stockholder vote is force-locked). FTV_NONE is party-free.
    {
      key: 'forceTheVoteType',
      label: 'Force the Vote — strength + party code (FTV_HARD/SOFT_TARGET/ACQUIRER/BOTH, or FTV_NONE)',
      type: 'tagged',
    },
    {
