...
const FEATURES = {
  ...
  'TERMR-MUTUAL': [
    { key: 'mainConcept', label: 'Main Concept (one-sentence summary)', type: 'text' },
    {
      key: 'partyWhoCanTerminate',
      label: 'Party Who Can Terminate',
      type: 'enum',
    ...
    { key: 'terminationTriggers', label: 'Termination Triggers', type: 'list' },
  ...
  'TERMR-OUTSIDE': [
    ...
    { key: 'outsideDateExtensionConditions', label: 'Outside Date Extension Conditions / Triggers', type: 'text' },
    ...
    { key: 'tickingFee', label: 'Ticking Fee / Reverse Ticking Fee', type: 'boolean' },
  ],
  ...
  'TERMR-EXTENSION': [
    ...
    { key: 'terminationTriggers', label: 'Triggers / Conditions for Extension', type: 'list' },
    ...
    { key: 'outsideDateExtensionConditions', label: 'Extension Conditions (free text)', type: 'text' },
  ...
  'TERMR-LEGAL': [
    ...
    { key: 'legalRestraintScope', label: 'Scope of Legal Restraint (e.g. final + non-appealable injunction; final order; permanent enjoinder)', type: 'text' },
    { key: 'restraintFinality', label: 'Finality Standard', type: 'enum', options: ['final-and-nonappealable', 'final', 'permanent', 'any'] },
  ],
  ...
  'TERMR-VOTE': [
    ...
    { key: 'terminationTriggers', label: 'Termination Triggers', type: 'list' },
    { key: 'faultBasedExclusion', label: 'Fault-Based Exclusion', type: 'boolean' },
    { key: 'voteRequiredThreshold', label: 'Required Stockholder Vote Threshold (e.g. majority of outstanding)', type: 'text' },
    { key: 'voteFailureContext', label: 'Vote Failure Context (e.g. duly convened meeting / final vote taken)', type: 'text' },
  ],
  ...
  'TERMR-BREACH-T': [
    ...
    { key: 'terminationTriggers', label: 'Termination Triggers', type: 'list' },
    { key: 'faultBasedExclusion', label: 'Fault-Based Exclusion (terminating party not in breach)', type: 'boolean' },
    { key: 'breachCurePeriod', label: 'Breach Cure Period (business days)', type: 'duration' },
    { key: 'breachMaterialityStandard', label: 'Breach Materiality Standard (e.g. would cause closing condition to fail)', type: 'text' },
  ],
  ...
  'TERMR-SUPERIOR': [
    ...
    { key: 'terminationTriggers', label: 'Termination Triggers', type: 'list' },
    { key: 'faultBasedExclusion', label: 'Fault-Based Exclusion', type: 'boolean' },
    { key: 'superiorProposalConditions', label: 'Conditions for Termination (e.g. compliance with no-solicit, payment of termination fee, board determination)', type: 'text' },
    { key: 'superiorProposalTermination', label: 'Target Can Terminate for Superior Proposal', type: 'boolean' },
    { key: 'simultaneousFeePayment', label: 'Termination Fee Payable Simultaneously with Termination', type: 'boolean' },
  ],
  ...
  'TERMR-RECOMMEND': [
    ...
    { key: 'terminationTriggers', label: 'Termination Triggers', type: 'list' },
    { key: 'faultBasedExclusion', label: 'Fault-Based Exclusion', type: 'boolean' },
    { key: 'recommendationChangeConditions', label: 'What Constitutes a Triggering Recommendation Change (e.g. withdrawal, modification, failure to reaffirm)', type: 'text' },
  ...
  'REP-T': [
    ...
    {
      key: 'mainConcept',
      label: 'Main Concept (one-sentence summary of THIS specific representation)',
      type: 'text',
      scope: 'clause',
    },
    {
