...
const FEATURES = {
  ...
  NOSOL: [
    ...
    // Coded hard/soft sibling to the forceTheVote boolean (which stays for
    // backward compatibility). Codebook: FORCE_THE_VOTE in lib/taxonomy.js.
    // The discriminator between FTV_HARD and FTV_SOFT is the existence of a
    // company self-termination right to accept a Superior Proposal.
    {
