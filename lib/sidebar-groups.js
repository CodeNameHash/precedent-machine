...
// Reps → MAE → Material Contracts → IOC → No-Sol → Antitrust → Conditions →
// Termination Rights → Termination Fees → rest. Seller/Target children sit
// before Buyer/Parent (block 4b). Keep in sync with the richer copy in
// components/review/shared.js (the review page's source of truth).
