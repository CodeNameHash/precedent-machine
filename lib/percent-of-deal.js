/* ─────────────────────────────────────────────────────────────────────────
   ...
   number before calling in (see lib/parse-money.js#parseMoneyAmount for the
   shared parser; lib/query/derived-fields.js#parseUsdAmount is now a thin
   wrapper over it, not its own implementation).
