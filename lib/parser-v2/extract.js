...
- erisaPlansListed (boolean, clause): true if the Company Benefit Plans are listed on the disclosure schedule.
- erisaCompliance (text, clause): ERISA compliance representation ("each Plan has been operated in compliance with ERISA").
- erisaTitleIVPlans (boolean, clause): true if there are any Title IV / defined-benefit plans.
- erisaMultiemployer (boolean, clause): true if the Company participates in a "multiemployer plan".
- erisaParachutePayments (text, clause): Parachute payments / 280G language.
