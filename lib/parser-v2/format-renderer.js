 ...
 *
 * Two helpers make up the public interface:
 ...
 * `parseInline` (REF/DEFINED inline-token parsing) is also exported for
 * granular testing but has no caller outside this file today; treat it as
 * an internal helper of parseFormattedDocument, not part of the interface.
 *
 * All three are pure functions; no React imports here, so this can run on
 * the server (e.g. for testing) and in the browser.
 */
