...
const ARTICLE_TYPE_MAP = [
  ...
  { pattern: /consideration|treatment\s+of\s+securit|securities?\s+treatment|conversion\s+of\s+shares|exchange\s+of\s+certificates|effect\s+on\s+capital\s+stock/i, type: 'CONSID' },
