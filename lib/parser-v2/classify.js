...
const DETERMINISTIC_RULES = [
  ...
  { pattern: /covenants?\s+of\s+(?:the\s+)?(?:company|target|seller)|conduct\s+of\s+(?:the\s+)?(?:company|target|seller)['’]?s?\s+business|interim\s+oper/i, type: 'IOC-T', overrideArticle: true },
  { pattern: /covenants?\s+of\s+(?:the\s+)?(?:parent|buyer|acqui\w+)|conduct\s+of\s+(?:the\s+)?(?:parent|buyer|acqui\w+)['’]?s?\s+business/i, type: 'IOC-B', overrideArticle: true },
...
const SUBCODE_REFINEMENT_RULES = [
  ...
  { pattern: /anti[\s-]*reliance|exclusivity\s+of\s+representations|no\s+other\s+representations/i, whenType: 'COV', code: 'REP-B-ANTIRELIANCE' },
  { pattern: /anti[\s-]*reliance|exclusivity\s+of\s+representations|no\s+other\s+representations/i, whenType: 'MISC', code: 'REP-B-ANTIRELIANCE' },
  // REP-T family
...
const ARTICLE_TYPE_MAP = [
  ...
  { pattern: /conduct\s+of\s+(?:the\s+)?(?:company|target|seller)|conduct\s+of\s+(?:the\s+)?(?:company|target|seller)['’]?s?\s+business/i, type: 'IOC-T' },
  { pattern: /conduct\s+of\s+(?:the\s+)?(?:parent|buyer|acqui)|conduct\s+of\s+(?:the\s+)?(?:parent|buyer|acqui\w+)['’]?s?\s+business/i, type: 'IOC-B' },
  { pattern: /conduct\s+of\s+business|interim\s+operat|conduct\s+prior/i, type: 'IOC-T' },
