...
function buildIsolationObservationSource(input) {
  ...
  if (input.previewDeployment.id !== input.previewDeploymentId
    || input.previewDeployment.target !== 'preview'
  ...
  return Object.freeze({
    ...
    unauthenticated_status: input.unauthenticatedResponse.status,
    unauthenticated_redirect_origin: unauthenticatedRedirectOrigin,
    authorised_status: input.authorisedResponse.status,
