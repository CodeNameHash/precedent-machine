...
function evidenceObjects(source) {
  return Object.freeze([
    ...
    Object.freeze({
      source_route_action_inventory: source.source_route_action_inventory,
      source_route_action_inventory_root: source.source_route_action_inventory_root,
      built_route_action_inventory: source.built_route_action_inventory,
      built_route_action_inventory_root: source.built_route_action_inventory_root,
      runtime_route_action_inventory: source.runtime_route_action_inventory,
      runtime_route_action_inventory_root: source.runtime_route_action_inventory_root,
