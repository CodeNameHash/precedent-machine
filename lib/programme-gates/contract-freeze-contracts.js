...
const CONTRACT_FREEZE_CONTRACT =
  'exact-contract-freeze-attestation-and-status-generation/v9';
...
const CONTRACT_FREEZE_CONTRACT_CONFIGURATION = Object.freeze({
  ...
  claim_inputs: Object.freeze({
    bundle_compiles: Object.freeze([
      ...
      input('ContractFreezeAttestationIdentity', '/approval_epoch_nonce'),
      input('ContractFreezeAttestationIdentity', '/predecessor_canonical_contract_bundle_member_root'),
      input('ContractFreezeAttestationIdentity', '/predecessor_canonical_contract_bundle_member_count'),
    ...
    semantic_and_identity_diff_reviewed: Object.freeze([
      ...
      input('ContractFreezeAuthorityEvidence', '/related_authority_ids'),
      input('ContractFreezeAuthorityEvidence', '/signature'),
      input('ContractDiffReviewAttestation', '/predecessor_contract_bundle_id'),
      input('ContractDiffReviewAttestation', '/predecessor_contract_bundle_digest'),
      input('ContractDiffReviewAttestation', '/predecessor_contract_members'),
      input('ContractDiffReviewAttestation', '/predecessor_canonical_contract_bundle_members'),
