...
const TRANSITIVE_EXECUTABLE_DOMAIN =
  'PROGRAMME_GATE_ACCEPTANCE_TRANSITIVE_EXECUTABLE/V1';
const ACCEPTANCE_EXECUTABLE_CLOSURE_DIGEST = programmeGateValidatorExecutableDigest({
...
const ENUMERATOR_EXECUTABLE_DIGEST = domainDigest(
  ENUMERATOR_EXECUTABLE_DOMAIN,
  {
    ...
    source_inventory_executable_digest: SOURCE_CONTAINMENT_INVENTORY_EXECUTABLE_DIGEST,
  },
);
...
const CONTRACT_CONFIGURATIONS = Object.freeze([
  Object.freeze({
    ...
    member_enumerator_executable_digest: ENUMERATOR_EXECUTABLE_DIGEST,
    ...
    claim_inputs: Object.freeze({
      live_route_zero_corpus_reads: Object.freeze([
        input('MarketStatsContainmentAttestation', '/method_probes'),
        input('MarketStatsContainmentAttestation', '/runtime_deployment_id'),
      ]),
    }),
  }),
  Object.freeze({
    ...
    claim_inputs: Object.freeze({
      source_built_and_runtime_route_inventories_equal: Object.freeze([
        input('BroadRouteContainmentAttestation', '/source_route_ids'),
        input('BroadRouteContainmentAttestation', '/built_route_ids'),
        input('BroadRouteContainmentAttestation', '/runtime_route_ids'),
      ]),
    }),
  }),
]);
...
function executableBindingsFor(configuration) {
  ...
  for (const claimKey of descriptor.ordered_claim_keys) {
    ...
    const predicateEntryDigest = domainDigest(
    ...
    predicateBindings[claimKey] = Object.freeze({
      ...
      executable_digest: domainDigest(
        TRANSITIVE_EXECUTABLE_DOMAIN,
        {
          executable_kind: 'PREDICATE',
          entry_executable_digest: predicateEntryDigest,
          transitive_source_closure_digest: ACCEPTANCE_EXECUTABLE_CLOSURE_DIGEST,
        },
      ),
  ...
  return Object.freeze({
    member_enumerator: Object.freeze({
      executable_digest: domainDigest(
        TRANSITIVE_EXECUTABLE_DOMAIN,
        {
          executable_kind: 'MEMBER_ENUMERATOR',
          entry_executable_digest: configuration.member_enumerator_executable_digest
