...
const schemas = Object.freeze({
  ...
  'StagingAccessProtectionAttestation/V1': {
    ...
    ...closedObject({
      unauthenticated_status: { type: 'integer', minimum: 100, maximum: 599 },
      unauthenticated_redirect_origin: {
        oneOf: [
          { const: 'https://vercel.com/sso-api' },
          { type: 'null' },
        ],
      },
      authorised_status: { type: 'integer', minimum: 100, maximum: 599 },
    }),
  },
  ...
  'ContractDiffReviewAttestation/V1': {
    ...
    ...closedObject({
      ...
      review_id: digest,
      frozen_contract_pair_digest: digest,
      semantic_diff_reviewed: { const: true },
      identity_diff_reviewed: { const: true },
