...
const PARTITIONS = Object.freeze([
  ...
  Object.freeze({
    queue_group_id: 'PRODUCTION_ACCESS_SECURITY_PREREQUISITE',
    phase: 'PRE_PRODUCTION_ACCESS',
    gate_ids: Object.freeze(CURRENT_LIVE_P9_GATE_IDS.slice(15, 16)),
  }),
  Object.freeze({
    queue_group_id: 'M4_PRODUCTION_IMPORT',
    phase: 'M4',
    gate_ids: Object.freeze(CURRENT_LIVE_P9_GATE_IDS.slice(16, 19)),
  }),
  Object.freeze({
    queue_group_id: 'LIVE_CUTOVER',
    phase: 'CUTOVER',
    gate_ids: Object.freeze(CURRENT_LIVE_P9_GATE_IDS.slice(19, 22)),
  }),
  Object.freeze({
    queue_group_id: 'RATIFIED_TERMINAL_COMPLETION',
    phase: 'COMPLETION',
...
function validateP9AcceptanceEvidenceEngineeringQueue(queue, { p9GateIds, repositoryRoot } = {}) {
  ...
  if (completion.gate_id !== COMPLETION_GATE_ID
    || completion.required_user_decision !== null) {
    throw new Error('P9 completion is not the ratified terminal engineering item');
  }
  return true;
}
