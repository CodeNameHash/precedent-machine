...
function validateTable(table, where, seenTableKeys, familyKeySet) {
  ...
  if (table.footer_from_subtype !== undefined) {
    ...
    const keys = footer && typeof footer === 'object' && Array.isArray(footer.subtype_keys) ? footer.subtype_keys : null;
    if (!footer || typeof footer !== 'object' || !isNonEmptyString(footer.label)
      || (keys === null ? !isNonEmptyString(footer.subtype_key) : (footer.subtype_key !== undefined || keys.length === 0 || keys.some((key) => !isNonEmptyString(key))))
