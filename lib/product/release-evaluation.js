...
function evaluateSupervisedRelease({ inventory, reconciliation, analysis, reviewState, legalSchema, citationAssessments, elapsedMinutes, developerAssisted }) {
  ...
  const bars = {
    ...
    review_within_ninety_minutes_without_developer: Number.isFinite(elapsedMinutes)
      && elapsedMinutes >= 0 && elapsedMinutes <= 90 && developerAssisted === false,
  };
  return Object.freeze({
    ...
    diagnostics: {
      ...
      review_time_minutes: elapsedMinutes, developer_assisted: developerAssisted,
    },
    bars,
