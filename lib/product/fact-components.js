...
// A PERIOD or DATE may be descriptive ("on the second Business Day following
// the satisfaction of the conditions"); it then carries value null. Money,
// percentages and thresholds always carry a number.
const DESCRIPTIVE_VALUE_KINDS = new Set(['PERIOD', 'DATE']);
