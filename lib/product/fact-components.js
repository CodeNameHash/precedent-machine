...
const HEADLINE_SUMMARY_RULE = 'summary is one plain-English line of at most ' + HEADLINE_SUMMARY_MAX_WORDS
  + ' words stating the provision\'s operative effect in the parties\' defined names (for example: Company files the Certificate of Merger with the Delaware Secretary of State), with no section reference, no quotation marks and no trailing period.';
const SUMMARY_SECTION_REFERENCE = /(\bSections?\s+\d|\bArticles?\s+[IVXLC\d]|§)/;
