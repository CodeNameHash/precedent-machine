...
const LEGACY_RESTRICTION_CATEGORY_QUOTE_ALIASES = freeze([
  { legacy_category: 'CHARTER', canonical_category: 'CHARTER_BYLAW_AMENDMENTS', source_quote: 'amend or propose to amend the Company’s Organizational Documents' },
  { legacy_category: 'SETTLE', canonical_category: 'LITIGATION_SETTLEMENTS', source_quote: 'pay, discharge, settle or satisfy any claims, liabilities or obligations (whether absolute, accrued, asserted or unasserted, contingent or otherwise)' },
  { legacy_category: 'SETTLE', canonical_category: 'LITIGATION_SETTLEMENTS', source_quote: 'the Company may not settle or propose to settle or compromise any Transaction Litigation' },
  { legacy_category: 'SETTLE', canonical_category: 'LITIGATION_SETTLEMENTS', source_quote: 'settle, waive or amend any claims or rights of substantial value' },
]);
...
const FINGERPRINT_INPUT_V1 = freeze({ version: VERSION, restriction_category_to_concept: RESTRICTION_CATEGORY_TO_CONCEPT, legacy_restriction_category_aliases: LEGACY_RESTRICTION_CATEGORY_ALIASES, legacy_restriction_category_quote_aliases: LEGACY_RESTRICTION_CATEGORY_QUOTE_ALIASES, category_tests: Object.fromEntries(Object.entries(CATEGORY_TESTS).map(([key, test]) => [key, test.toString()])), v2_category_to_v1_keys: V2_CATEGORY_TO_V1_KEYS, near_miss_anchor: ['ordinary', 'course'] });
const DIGEST = registryFingerprint(FINGERPRINT_INPUT_V1);
module.exports = freeze({ VERSION, RESTRICTION_CATEGORY_TO_CONCEPT, LEGACY_RESTRICTION_CATEGORY_ALIASES, LEGACY_RESTRICTION_CATEGORY_QUOTE_ALIASES, SETTLE_INSURANCE_CASUALTY_REPLAY_QUOTE, CATEGORY_TESTS, V2_CATEGORY_TO_V1_KEYS, FINGERPRINT_INPUT_V1, DIGEST });
