...
const representationTopic = require('./representation-topic-registry');
const SCHEMA_VERSION = 'RESOLUTION_REGISTRY_SUBSTRATE_MANIFEST/V1';
const modules = freeze([
  ['materiality-qualifier', materiality], ['closing-condition-kinds', closing], ['general-covenant', general], ['material-contract', contracts], ['interim-operating', interim], ['party-capacity', party], ['representation-topic', representationTopic],
