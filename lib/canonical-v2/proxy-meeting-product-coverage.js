...
const ROW_COVERAGE = Object.freeze({
  ...
  'votes-approvals-meeting-mailing': Object.freeze({
    owner_id: 'PROXY_MEETING_COVENANTS',
    governance_state: 'EVIDENCE_ONLY',
    claim_keys: Object.freeze([]),
  }),
  ...
  'votes-approvals-meeting-boardRecommendationInclusion': Object.freeze({
    owner_id: 'PROXY_MEETING_COVENANTS',
    governance_state: 'REGISTERED_FIRST_SLICE',
    claim_keys: Object.freeze(['BOARD_RECOMMENDATION_INCLUSION']),
  }),
  'votes-approvals-meeting-meetingConveneObligation': Object.freeze({
    owner_id: 'PROXY_MEETING_COVENANTS',
    governance_state: 'REGISTERED_FIRST_SLICE',
    claim_keys: Object.freeze(['MEETING_CONVENE_OBLIGATION']),
  }),
