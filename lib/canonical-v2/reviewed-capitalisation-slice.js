...
const REVIEWED_SECTIONS = Object.freeze({
  '3.3': Object.freeze({
    ...
    proposal_id: '6352c44ede9cb0f85a0caa4398651c0d999e69854144eb33c1add02254a3fe65',
  }),
  '6.3': Object.freeze({
    title: 'Conditions to Obligations of Parent and Merger Sub to Effect the Closing',
    proposal_id: 'af37cac3ad928b628a7efc587ed5e7dc639e30e1f296c49fd915cb3f3241062d',
  }),
});
...
function buildReviewedCapitalisationSlice({ sourceText, contractBundle, corpusReleaseId } = {}) {
  ...
  const knowledgeClaim = buildClaimRevision({
    ...
    scope: {
      scope_closure_id: contentId('CLAIM_SCOPE_CLOSURE/V1', {
        ...
        governed_interval_ids: repScopeIntervalIds,
      }),
      coverage_status: 'COMPLETE',
      required_interval_ids: repScopeIntervalIds,
      examined_interval_ids: repScopeIntervalIds,
    },
  ...
  const canonicalWriteSet = {
    ...
    claims: [accuracyClaim, exceptionClaim, knowledgeClaim].map((row) => ({ ...row, closure_id: semanticClosureId })),
  ...
  const reviewedMapping = {
    ...
    canonical_object_ids: [
      ...
      knowledgeClaim.claim_revision_id,
