...
const LEGACY_AUTHORITY_STATUS = 'OBSOLETE_V1_NON_AUTHORITY';
...
function buildDealIdentityAuthorityAttestation({
  ...
  void deal_identity_manifest;
  void authority_reference_id;
  fail(
    'OBSOLETE_V1_DEAL_IDENTITY_NON_AUTHORITY',
    'DEAL_IDENTITY_AUTHORITY_ATTESTATION/V1 is quarantined and cannot create identity authority. Use signed or frozen V2 identity evidence.',
  );
}
...
function validateDealIdentityAuthorityAttestation({
  ...
  fail(
    'OBSOLETE_V1_DEAL_IDENTITY_NON_AUTHORITY',
    'DEAL_IDENTITY_AUTHORITY_ATTESTATION/V1 is quarantined and cannot validate identity authority. Use signed or frozen V2 identity evidence.',
  );
}
