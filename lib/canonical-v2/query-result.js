...
const DEAL_RELATIVE_MONEY_METRICS = Object.freeze([FEE_METRIC, IOC_CAPEX_METRIC, MATERIAL_CONTRACT_METRIC]);
const QUERY_METRICS = Object.freeze([...DEAL_RELATIVE_MONEY_METRICS, NO_SHOP_NOTICE_METRIC]);
...
const COLUMN_DEFINITIONS = Object.freeze({
  ...
  duration: Object.freeze({ label: 'Duration', value_kind: 'DURATION', metrics: [NO_SHOP_NOTICE_METRIC], refinement: null }),
  day_basis: Object.freeze({ label: 'Day basis', value_kind: 'CODED_VALUE', metrics: [NO_SHOP_NOTICE_METRIC], refinement: null }),
  trigger: Object.freeze({ label: 'Trigger', value_kind: 'CODED_VALUE', metrics: [NO_SHOP_NOTICE_METRIC], refinement: null }),
