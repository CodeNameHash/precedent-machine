...
function queryDefinitionDigest(kind, admission, authorityContext) {
  ...
  return contentId('METSERA_EXCLUSIVITY_PRODUCT_QUERY_DEFINITION/V1', {
    ...
    checked_process_admission_evidence: {
      ...
      narration_revision: input.narration_revision,
      predicate_witness_revision: input.predicate_witness_revision,
      atomic_response_predicate_witness_revision:
        input.atomic_response_predicate_witness_revision,
      result_input_lineage: input.result_input_lineage,
      matched_passage_preview: input.matched_passage_preview,
      exact_detail_reference: input.exact_detail_reference,
    },
...
function queryDefinition(kind, admission, authorityContext) {
