...
function readCurrentPendingIdentityPacket({ artifact_root: artifactRoot } = {}) {
  ...
  if (packet.status !== 'PENDING_NAMESPACE_AND_KEY_DOMAIN_RATIFICATION'
    || packet.admission_authority !== 'NONE' || packet.source_admission_authority !== 'NONE'
    || packet.deal_admission_authority !== 'NONE') {
    fail('PENDING_IDENTITY_PACKET_STATUS_INVALID', 'only the current non-authoritative pending identity packet may enter this readiness receipt.');
  }
