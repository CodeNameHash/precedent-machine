...
function validateRelationshipMember(member) {
  ...
  if (
    ...
    || !EFFECT_MODES.includes(value.effect_mode)
...
function validateAuthoredRelationshipInputs(authoredMembers) {
  ...
  for (const relationship of relationships) {
    ...
    if (
      ...
      || (effect.definition.effect_mode != null
        && effect.definition.effect_mode !== relationship.effect_mode)
    ) {
      fail(
        ...
        'Relationship effect schema does not bind the selected relationship version.',
        {
          ...
          relationship_effect_mode: relationship.effect_mode,
          effect_schema_mode: effect.definition.effect_mode ?? null,
        },
      );
    }
