 ...
 *
 * ADOPTION STATE, CHECKED DIRECTLY (not assumed from the paragraph above):
 * none of the three named oracle modules -- reviewed-termination-fee-slice.js,
 * reviewed-qxo-no-shop-slice.js, reviewed-no-shop-slice.js -- import this
 * harness; each still hand-rolls its own construction exactly as before this
 * harness existed. The description above explains the SHAPE of what this
 * harness mechanises (the same mechanics those three modules hand-roll), not
 * a claim that they call it. As of this writing the only real caller is
 * `__fixtures__/canonical-v2/qxo-termination-fee-row.js`, a single new
 * fixture built directly against this harness; migrating the three existing
 * oracles onto it is unstarted work, not a completed refactor.
 */
