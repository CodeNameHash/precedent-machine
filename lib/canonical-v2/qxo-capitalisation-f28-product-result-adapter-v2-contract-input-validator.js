...
function validateDefinition(definition, code) {
  ...
  requireExactKeys(definition.product_query_ir_binding_contract, [
    ...
    'candidate_release_manifest_id_must_equal_validated_release_manifest_id',
    'candidate_release_manifest_payload_digest_must_equal_validated_release_manifest_payload_digest',
    'cross_view_release_identity_substitution_permitted',
  ...
  if (
    ...
    || definition.product_query_ir_binding_contract.candidate_release_manifest_id_source
      !== 'VALIDATED_CROSS_VIEW_RELEASE_MANIFEST_ID'
    || definition.product_query_ir_binding_contract.candidate_release_manifest_payload_digest_source
      !== 'VALIDATED_CROSS_VIEW_RELEASE_MANIFEST_PAYLOAD_DIGEST'
    || definition.product_query_ir_binding_contract.candidate_release_manifest_id_must_equal_validated_release_manifest_id !== true
    || definition.product_query_ir_binding_contract.candidate_release_manifest_payload_digest_must_equal_validated_release_manifest_payload_digest !== true
    || definition.product_query_ir_binding_contract.cross_view_release_identity_substitution_permitted !== false
    || definition.product_query_ir_binding_contract.query_ir_can_substitute_or_rehash_candidate_manifest !== false
  ) fail(code, 'Product Query IR must bind the exact validated release manifest.');
