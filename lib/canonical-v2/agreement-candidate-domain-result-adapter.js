...
const PROFILE_ADMISSIONS = Object.freeze({
  CAPITALISATION_BRING_DOWN_V3: Object.freeze({
    ...
    domain_validator: Object.freeze({
  ...
  IOC_CAPEX_RESTRICTION_V1: Object.freeze({
    ...
    domain_validator: Object.freeze({
      stable_id: 'AGREEMENT_CANDIDATE_DOMAIN_RESULT_ADAPTER',
      version: 1,
    }),
  }),
});
...
function buildAgreementCandidateDomainResult(input = {}) {
  ...
  const validationBody = {
    validator_stable_id: profile.domain_validator.stable_id,
    validator_version: profile.domain_validator.version,
