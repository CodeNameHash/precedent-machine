...
const TARGET_CAPEX_DETAIL_ACTION_STABLE_ID = 'RESULT_COMPONENT_CLAIM_EVIDENCE';
...
const CATALOGUES = Object.freeze([
  ...
  Object.freeze({
    ...
    definition_digest:
      '53f90cb068256df6d9212e73197330da1d0d9e3f020ebf6e72cd830ebe184089',
...
function validatePredicateDefinition(predicate, catalogue) {
  ...
  if (
    ...
    || admission.exact_detail_action_stable_id !== (
      catalogue.predicate_key === TARGET_CAPEX_PREDICATE_KEY
