...
function assembleCanonicalContractBundlePreReviewPackage(input = {}) {
  ...
  const successorDigest = firstCompilation.contract_bundle_digest;
  const successorId = firstCompilation.contract_bundle_id;

  const preReviewAttestationIdentityUnsigned = {
  ...
  const preReviewAttestationIdentity = {
    ...preReviewAttestationIdentityUnsigned,
    contract_freeze_attestation_id: domainDigest(
      'PROGRAMME_GATE_CONTRACT_FREEZE_ATTESTATION_ID/V1',
      preReviewAttestationIdentityUnsigned,
    ),
  };
  const preReviewFrozenPairDigest = domainDigest(
    'PROGRAMME_GATE_FROZEN_CONTRACT_PAIR/V1',
    {
      ...
      contract_freeze_attestation_id:
        preReviewAttestationIdentity.contract_freeze_attestation_id,
    },
  );
  ...
  const preReviewExactInputContextDigest = domainDigest(
    'PROGRAMME_GATE_CONTRACT_DIFF_REVIEW_EXACT_INPUT_CONTEXT/V1',
    {
      ...
      contract_bundle_id: successorId,
      contract_bundle_digest: successorDigest,
      frozen_contract_pair_digest: preReviewFrozenPairDigest,
  ...
  const exactReviewPackage = {
    ...
    code_commit: frozenInput.code_commit,
    environment: frozenInput.environment,
    pre_review_contract_freeze_attestation_identity: preReviewAttestationIdentity,
    pre_review_frozen_contract_pair_digest: preReviewFrozenPairDigest,
    predecessor_contract_bundle_id: predecessorId,
    predecessor_contract_bundle_digest: predecessorDigest,
    ...
    semantic_identity_diff_digest: semanticIdentityDiffDigest,
    pre_review_exact_input_context_digest: preReviewExactInputContextDigest,
