...
const TYPE_SPECS = Object.freeze({
  ...
  ConsiderationPackage: Object.freeze({
    stableId: 'CONSIDERATION_PACKAGE',
    slotKind: 'CONSIDERATION_PACKAGE_SLOT',
    slotSchema: 'CONSIDERATION_PACKAGE_SLOT/V1',
    occurrenceDomain: 'CONSIDERATION_PACKAGE/V1',
    occurrenceInputs: Object.freeze([
      'expected_consideration_package_slot_key',
      'governed_deal_id',
      'governed_ordinal',
      'source_position_slot_key',
    ]),
    excludedValueFields: Object.freeze([
      'components',
      'package_total',
    ...
    revisionType: 'ConsiderationPackageRevision',
    revisionDomain: 'CONSIDERATION_PACKAGE_REVISION/V1',
    revisionInputs: Object.freeze([
      'bidder_track_id',
      'components',
      'consideration_package_id',
    ...
    carrierKind: 'CANDIDATE_RELEASE_COMPONENT_TABLE',
    carrierName: 'consideration_packages',
    sourceOccurrenceRequired: true,
    approvedSeedAttestationPermitted: false,
    evidenceCoordinateSpace: 'ADMITTED_SOURCE_UTF8_BYTES',
    writerAction: 'MATERIALISE_CONSIDERATION_PACKAGE',
    terminalType: 'CONSIDERATION_PACKAGE_REVISION',
    detailAction: 'CONSIDERATION_PACKAGE_EVIDENCE',
  }),
...
function validateConsiderationPackageContract(value, code) {
  requireExactKeys(value, [
    'component_schema',
    'component_identity_inputs',
    'component_prohibited_identity_inputs',
    'component_types',
    'component_state_and_exact_evidence_required',
    'same_deal_and_release_required',
    'exact_source_formulation_retained',
    'currency_and_value_basis_required_when_applicable',
    'cash_dividend_cvr_and_stock_components_remain_separate',
    'target_paid_dividend_automatically_added_to_offer_price',
    'cvr_ceiling_automatically_added_to_offer_price',
    'tiered_prices_collapsed_to_one_price',
    'package_total_requires_governed_derivation',
    'package_total_derivation_requires_all_component_lineage',
    'uncertain_or_contingent_component_requires_typed_state',
    'display_label_can_create_component_type',
    'process_can_reauthor_shared_economic_fact',
  ], 'ConsiderationPackage type contract', code);
  if (value.component_schema !== 'CONSIDERATION_PACKAGE_COMPONENT/V1') {
    fail(code, 'ConsiderationPackage component schema is not registered.');
  }
  requireExactArray(value.component_identity_inputs, [
    'consideration_package_id',
    'component_type',
    'governed_ordinal',
    'source_interval',
  ], 'ConsiderationPackage component identity inputs', code);
  requireExactArray(value.component_prohibited_identity_inputs, [
    'canonical_value',
    'currency',
    'display_label',
    'estimated_value',
    'probability',
  ], 'ConsiderationPackage prohibited component identity inputs', code);
  requireExactArray(value.component_types, [
    'CASH_PER_SHARE',
    'CVR',
    'OTHER_GOVERNED',
    'STOCK',
    ...
    'TIERED_PRICE',
  ], 'ConsiderationPackage component types', code);
  requireExactObject(value, {
    component_schema: 'CONSIDERATION_PACKAGE_COMPONENT/V1',
    component_identity_inputs: [
      'consideration_package_id',
      'component_type',
      'governed_ordinal',
    ...
    component_state_and_exact_evidence_required: true,
    same_deal_and_release_required: true,
    exact_source_formulation_retained: true,
    currency_and_value_basis_required_when_applicable: true,
    cash_dividend_cvr_and_stock_components_remain_separate: true,
    target_paid_dividend_automatically_added_to_offer_price: false,
    cvr_ceiling_automatically_added_to_offer_price: false,
    tiered_prices_collapsed_to_one_price: false,
    package_total_requires_governed_derivation: true,
    package_total_derivation_requires_all_component_lineage: true,
    uncertain_or_contingent_component_requires_typed_state: true,
    display_label_can_create_component_type: false,
    process_can_reauthor_shared_economic_fact: false,
  }, 'ConsiderationPackage contract', code);
}
...
function validateLogicalTypeMember(member) {
  ...
  const typeValidators = {
    ...
    ConsiderationPackage: validateConsiderationPackageContract,
