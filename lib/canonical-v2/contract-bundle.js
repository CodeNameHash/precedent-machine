...
function validateInput(input) {
  ...
  if (input.serving_trigger_path_schemas != null) {
    // Step 3J: V4 through V38 carry exactly [V2] (inherited unchanged, never
    // re-declared); V39 adds V3 alongside it, never in place of it. Branch
    // on the input's own length rather than on a version number so this
    // still refuses anything that is not one of those two exact, frozen
    // shapes.
    assertExact(
