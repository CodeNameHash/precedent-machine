...
// separate legal standard. No committed V2 resolution.json carries the
// retired code, so narrowing in place does not orphan stored V2 claims.
// V1 MATERIALITY_CODES keeps the key for legacy data/UI. WIDENING (of
