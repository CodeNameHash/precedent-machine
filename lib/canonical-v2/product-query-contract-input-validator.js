...
const PRODUCT_QUERY_CONTRACT_IDS = Object.freeze([
  'AGREEMENT_CANDIDATE_PRODUCT_MATERIALISATION',
...
const PRODUCT_QUERY_CONTRACT_DEFINITIONS = Object.freeze({
  AGREEMENT_CANDIDATE_PRODUCT_MATERIALISATION: Object.freeze({
    contract_type: 'AGREEMENT_CANDIDATE_PRODUCT_MATERIALISATION',
    definition_digest:
      'a5abc4b37aa1bbae1ed935fa8c3b398283a3e766839757792e856618752e1b6a',
    error_code:
      'INVALID_AGREEMENT_CANDIDATE_PRODUCT_MATERIALISATION_CONTRACT_INPUT',
  }),
  AGREEMENT_CANDIDATE_ENVELOPE: Object.freeze({
    contract_type: 'AGREEMENT_CANDIDATE_ENVELOPE',
    definition_digest:
      '71e4ec4e55ff8ad86c4125d58f4aa6aef79917d5a1abd885f570f564ce608484',
    error_code:
      'INVALID_AGREEMENT_CANDIDATE_ENVELOPE_CONTRACT_INPUT',
  }),
  ...
  PRODUCT_RESULT_SURFACE_BINDING: Object.freeze({
    contract_type: 'RESULT_SURFACE_BINDING',
    definition_digest:
      '68e9d3155e10966b87646d4ded888dfd7eea12d579660932af17527eb71e7779',
    error_code: 'INVALID_PRODUCT_RESULT_SURFACE_BINDING_CONTRACT_INPUT',
  }),
});
...
function requireExactArray(value, expected, label, code) {
  ...
  if (!Array.isArray(value) || canonicalJson(value) !== canonicalJson(required)) {
