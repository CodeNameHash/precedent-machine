...
function compileGovernedTopologyInputs({
  ...
  for (const fixtureSet of orderedFixtureSets) {
    ...
    for (const fixture of fixtureSet.fixtures) {
      ...
      if (
        fixture.template_id === 'QXO_CAPITALISATION_RESULT_DETAIL'
        && (
          fixture.canonical_input?.carried_result_adapter
            !== 'QXO_CAPITALISATION_F28_PRODUCT_RESULT_ADAPTER'
        )
      ) {
        fail(
          'RETIRED_QXO_CAPITALISATION_RESULT_ADAPTER',
          'The QXO result-detail golden fixture must use the active F28 result adapter.',
        );
      }
      fixtures.push({
