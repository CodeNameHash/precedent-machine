  ...
  return [
    {
      ...
      required_effect_fields: conditionalSchema.required_effect_fields,
      endpoint_contract: {
    ...
    },
    {
      ...
      required_effect_fields: inlineSchema.required_effect_fields,
      endpoint_contract: {
...
function validateExceptedByDefinition(definition, authoredMembers) {
  ...
  if (
    ...
    || conditionalSchema.effect_mode !== 'TYPED_LEGAL_EFFECT'
    || conditionalSchema.effect_variant !== 'CONDITIONAL_ACTION_PERMISSION'
    || conditionalSchema.relationship_key !== 'EXCEPTED_BY'
    || conditionalSchema.relationship_definition_version !== 3
    || !inlineSchema
    || inlineSchema.effect_schema !== 'NO_SHOP_INLINE_PERMISSION_EFFECT/V1'
    || inlineSchema.effect_mode !== 'TYPED_LEGAL_EFFECT'
    || inlineSchema.effect_variant !== 'INLINE_PERMISSION'
    || inlineSchema.relationship_key !== 'EXCEPTED_BY'
    || inlineSchema.relationship_definition_version !== 3
    || !same(
