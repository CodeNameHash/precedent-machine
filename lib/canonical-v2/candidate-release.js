...
function buildFixtureCandidateRelease({
  ...
  const manifestBody = {
    schema_version: hasIncompleteCanonicalRows
  ...
  const manifestIdentityVersion = hasIncompleteCanonicalRows ? 'V2' : 'V1';
...
function validateCandidateReleaseManifest(manifest) {
  ...
  requireExactKeys(manifest.counts, [
    ...
    'exclusions',
    'shared_rows',
    ...(isV2 ? ['incomplete_canonical_rows'] : []),
  ...
  requireExactKeys(manifest.roots, [
    ...
    'exclusion_root',
    'shared_row_root',
    ...(isV2 ? ['incomplete_canonical_row_root'] : []),
  ...
  const identityVersion = isV2 ? 'V2' : 'V1';
...
function validateCandidateReleaseBundle(release) {
  ...
  if (!['FIXTURE_CANDIDATE_RELEASE_BUNDLE/V1', 'FIXTURE_CANDIDATE_RELEASE_BUNDLE/V2']
  ...
  const countChecks = {
    ...
    ...(isV2 ? { incomplete_canonical_rows: release.incomplete_canonical_rows.length } : {}),
