...
function buildAdmission({ materialisation_receipt, candidate_release_binding, pilot_product_authority_context, pilot_product_authority_input }) {
  exactKeys(arguments[0], [
    'materialisation_receipt', 'candidate_release_binding',
...
function validateMetseraExclusivityProcessPhrasebookAdmission(value) {
  const rebuilt = buildAdmission({ materialisation_receipt: value?.materialisation_receipt, candidate_release_binding: value?.candidate_release_binding, pilot_product_authority_context: value?.pilot_product_authority_context, pilot_product_authority_input: value?.pilot_product_authority_input });
