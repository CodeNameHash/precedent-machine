...
function validateReceipt(receipt, input, sourceBytesByIdentity) {
...
function buildAdmission({ materialisation_input, materialisation_receipt, candidate_release_binding, pilot_product_authority_context, pilot_product_authority_input }, sourceBytesByIdentity) {
  ...
  validateReceipt(receipt, materialisationInput, sourceBytesByIdentity);
...
function compileMetseraExclusivityProcessPhrasebookAdmission(
  input,
  sourceBytesByIdentity,
) {
  return deepFreeze(buildAdmission(clone(input), sourceBytesByIdentity));
}
function validateMetseraExclusivityProcessPhrasebookAdmission(
  value,
  sourceBytesByIdentity,
) {
  const rebuilt = buildAdmission({ materialisation_input: value?.materialisation_input, materialisation_receipt: value?.materialisation_receipt, candidate_release_binding: value?.candidate_release_binding, pilot_product_authority_context: value?.pilot_product_authority_context, pilot_product_authority_input: value?.pilot_product_authority_input }, sourceBytesByIdentity);
