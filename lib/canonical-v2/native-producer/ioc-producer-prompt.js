...
const PROMPT_ID = 'native-producer-interim-operating/v6';
const IOC_PROMPT_VERSION = 6;

const RESTRICTION_CATEGORIES = Object.freeze(IOC_CATEGORIES_CANONICAL.map((entry) => entry.key));
const RESTRICTION_CATEGORY_ENUM = RESTRICTION_CATEGORIES.join(' | ');
  ...
  "ioc_restriction_assertions": [
    {
      ...
      "restriction_category": "${RESTRICTION_CATEGORY_ENUM}",
...
CONTROLLED CATEGORIES. Use exactly one of the twenty-five V1 restriction_category codes listed below. Do not force loans or investments, affirmative obligations, preambles, general exceptions, consent standards, numeric mechanics, notice windows, or another novel shape into the nearest restriction category. Preserve these items in ioc_mechanics or open_world_candidates.
