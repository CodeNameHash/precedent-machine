 ...
 * both still refuse).
 *
 * Step 2X-B: when the primary tables miss, a second chance runs through
 * lib/vocab/tax-cooperation-legacy.js (pre-3G inline shapes plus one
 * design-spec phrase). Primary hits stay byte-identical.
 * Step 2X-C: `taxCooperationPrimaryMatchingKinds` runs both primary tables
 * at runtime; enforcement is report-only until the collision report is read.
 */
