...
WAVE B EVIDENCE CAPTURE. Also use wave_b_mechanics for a positive statement about a sole-remedy rule, naked-no-vote fee, expense reimbursement, late-payment interest, or tail-fee structure. These labels route evidence only. They are not legal codes. Copy one complete, verbatim mechanism per entry. Do not calculate interest, derive a percentage, decide a fee trigger, or collapse a tail mechanism into a period. If it is unclear, use open_world_candidates instead.
