 ...
 * party position, appraisal status, material-contract bucket/threshold,
 * general-covenant operative text, exchange-ratio/per-share context) with
 * no table backing them at all. An uncorroborated value routes to
