...
function resolveCandidates({
  ...
  if (![REPRESENTATION_QUALIFIER_DISPATCH_MODES.OFF, REPRESENTATION_QUALIFIER_DISPATCH_MODES.REPORT_ONLY].includes(representationQualifierDispatchMode)) {
    throw new TypeError('representation_qualifier_dispatch_mode must be OFF or REPORT_ONLY in resolveCandidates');
  }
  ...
  function recordRepresentationQualifierDispatch({ entry, claim, conceptKey, qualifierKind }) {
    if (representationQualifierDispatchMode !== REPRESENTATION_QUALIFIER_DISPATCH_MODES.REPORT_ONLY
    ...
    if (classification.outcome === 'REVIEW' && classification.reason === QUALIFIER_KIND_DISAGREEMENT) {
      representationQualifierDispatchDecisions.push(Object.freeze({
        ...base,
        disposition: 'REVIEW',
  ...
  function handleRepresentationQualifierCarrier(entry) {
    ...
    recordRepresentationQualifierDispatch({ entry, claim, conceptKey, qualifierKind });
  ...
  return Object.freeze({
    ...
    ...(duplicateSuppressionMode !== DUPLICATE_SUPPRESSION_MODES.OFF
      ...
      : {}),
    ...(representationQualifierDispatchMode === REPRESENTATION_QUALIFIER_DISPATCH_MODES.REPORT_ONLY
