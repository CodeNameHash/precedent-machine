...
const { wordsToNumber, trailingNumberWordsPhrase } = require('../../normalize-numeric');
...
function resolveCandidates({
  ...
  // Resolver API permits OFF/REPORT_ONLY only. ENFORCE remains direct-module
  // test-only until a separate activation decision.
  ...
  if (![DUPLICATE_SUPPRESSION_MODES.OFF, DUPLICATE_SUPPRESSION_MODES.REPORT_ONLY].includes(duplicateSuppressionMode)) {
    throw new TypeError('duplicate_suppression_mode must be OFF or REPORT_ONLY in resolveCandidates');
  }
