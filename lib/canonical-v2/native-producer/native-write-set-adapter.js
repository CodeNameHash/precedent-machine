...
// nothing here produces that kind of row. `provisions` stays empty: the
// adapter mints components against provisions the CALLER already minted
// (`resolution.provisions`), never provisions themselves -- exactly as this
// module never mints provisions for CHAPEAU-level subjects either (see the
// module header's "WHAT THIS MODULE DOES NOT SOLVE").
