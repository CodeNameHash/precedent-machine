...
function shapeSpecificPerformanceRemedyProposals(parsed, sourceText) { return shapePresenceAssertions({ parsed, sourceText, listKey: 'remedy_assertions', claimKey: SPECIFIC_PERFORMANCE_REMEDY_CLAIM_KEY, proposalKind: SPECIFIC_PERFORMANCE_REMEDY_PROPOSAL_KIND, allowedKinds: REMEDY_ASSERTION_KINDS, subjectKind: 'SPECIFIC_PERFORMANCE_REMEDY' }); }
