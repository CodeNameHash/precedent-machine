 ...
 *
 * THREE TIERS, EACH STRICTLY ADDITIVE OVER THE LAST (never removes a way a
 * label could already be verified, only adds new ones -- see
 * verifyMaeClauseLabel's own header immediately below for the full account,
 * and the design note for the empirical count against TopBuild's real 17).
 *
...
function verifyMaeClauseLabel({
  ...
  return viaSibling.outcome === 'SELECTED'; // tier 3
}
