...
PRESERVE THE NOVEL. Capture every CVR, election alternative, allocation rule, default treatment, election deadline, proration formula, equity-award treatment, collar, ticking fee, withholding rule and exchange mechanic in consideration_mechanics. Keep each exact proposition separate. Do not calculate a formula, resolve a separate CVR Agreement, infer an election object, or force any mechanic into the three controlled kinds. Use open_world_candidates for novel shapes outside the observed surface list.
