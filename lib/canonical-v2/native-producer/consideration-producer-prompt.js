...
const ELECTION_MECHANIC_FIELDS = Object.freeze([
  'alternatives', 'default_treatment', 'cash_cap', 'equity_cap',
...
PRESERVE THE NOVEL. Capture every CVR, election alternative, allocation rule, default treatment, election deadline, proration formula, equity-award treatment, collar, ticking fee, withholding rule and exchange mechanic in consideration_mechanics. Keep each exact proposition separate. For an election, populate only the exact alternatives, default, cap and numerator/denominator operands that appear in the same quote. Do not calculate an allocation or a formula, resolve a separate CVR Agreement, or add a CVR-agreement component. Use open_world_candidates for novel shapes outside the observed surface list.
