 ...
 *
 * Corroboration vocabulary for the 17 GENERAL_COVENANT_FOLLOW_ON_OWNERS
 ...
 * Returns true iff `code` is a known code AND at least one of its patterns
 * fires on `quote`. Unknown codes never corroborate (the caller already
 * gates on GENERAL_COVENANT_CODES membership before reaching this, but this
 * function stays safe standalone too).
 */
