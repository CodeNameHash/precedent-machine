 ...
 * matches nothing, a second chance runs through lib/vocab/
 * general-covenant-rubric-presentation.js (the pre-3G rubric label/alias
 * vocabulary). Primary hits stay byte-identical -- no provenance enrichment
 * on that path. Step 2X-C: `generalCovenantPrimaryMatchingCodes` runs the
 * full primary table at runtime; enforcement is report-only until the
 * collision report is read (see scripts/canonical-v2-corroboration-
 * collision-report.mjs).
 */
