...
const {
  MATERIALITY_CODES,
  QUALIFIER_ACCURACY_CODES: ACCURACY_CODES,
...
const {
  QUALIFIER_KINDS, QUALIFIER_KIND_DISAGREEMENT, QUALIFIER_KIND_UNCLASSIFIED,
  DISCLOSURE_CARVEOUT_PARTIAL, DISCLOSURE_CARVEOUT_UNCORROBORATED, PERFORMANCE_ASSUMPTION_LEVEL_UNDERIVABLE,
  IDENTITY_BEARING_KINDS, LEGACY_HINT_ABSTENTION_KINDS, KNOWLEDGE_PATTERNS,
  TEMPORAL_CALENDAR_MONTH, TEMPORAL_CALENDAR_DATE_PATTERN_SOURCE, TEMPORAL_CALENDAR_DATE_PATTERN, TEMPORAL_SYMBOLIC_DATES,
  AS_OF_BRIDGE_PATTERN_SOURCE, TEMPORAL_PERIOD_ENDPOINT_SOURCE, ACCURACY_PATTERNS, THRESHOLD_PATTERNS,
} = require('../../vocab/resolution/materiality-qualifier-registry');
...
const {
  ACCURACY_CODE_WHITELIST, MAE_QUALIFIER_IDIOM_PATTERN, MAE_TOLERANCE_FAILURE_IDIOM_PATTERN,
  DISCLOSURE_CARVEOUT_VERB, DISCLOSURE_CARVEOUT_CITATION_TOKEN, DISCLOSURE_CARVEOUT_ANCHOR, DISCLOSURE_CARVEOUT_CONNECTIVE,
  DISCLOSURE_CARVEOUT_CLAUSE_PATTERN, DISCLOSURE_CARVEOUT_SIGNAL_PATTERN, ENUMERATED_EXCEPT_DISCLOSURE_CARVEOUT_SIGNAL_PATTERN,
  EXCEPT_FAMILY_CONNECTIVE_PATTERN, CARVEOUT_SIGNAL_CONNECTIVE_WINDOW,
} = require('../../vocab/resolution/materiality-qualifier-registry');
