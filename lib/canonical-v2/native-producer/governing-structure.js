...
/**
 * Structural adapter for findTerminationLimbChapeau.
 *
 ...
 * trims to the chapeau head at the first of `:` / `;` / newline. Semantic
 * direction parsing stays in candidate-resolution.js.
 *
