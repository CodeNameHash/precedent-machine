...
/*
 * Analysis-only corroboration ladder. This module deliberately does not
 * import the resolver, write set, storage, or serving code.
 */
...
const { MATERIAL_CONTRACT_BUCKET_META, MATERIAL_CONTRACT_BUCKET_CODES } = require('../../taxonomy');
...
module.exports = freeze({ LADDER_VERSION, FAMILIES, RUNGS, DERIVATIONS, PUBLICATION_DISPOSITION, ANCHOR_STEM_DECLARATIONS, ANCHOR_STEM_DECLARATION_DIGEST, normaliseForm, criterionIdentity, assessCorroborationLadder });
