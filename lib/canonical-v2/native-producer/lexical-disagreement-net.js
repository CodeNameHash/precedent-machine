...
const LEXICAL_FAMILY_LEXICON_VERSION = 10;
...
const ANTI_LITIGATION_PHRASES = Object.freeze([
  ['VIGOROUSLY_CONTEST', 'vigorously contest', 'Mandatory litigation drafting tell.'], ['DEFENDING_THROUGH_LITIGATION', 'defending through litigation', 'Mandatory litigation drafting tell.'], ['JUDICIAL_APPEAL', 'judicial appeal', 'Mandatory litigation drafting tell.'],
...
const EMPLOYEE_DNO_PHRASES = Object.freeze([
  ...
  phraseEntry('NO_LESS_FAVORABLE', 'COV-EMPLOYEE', 'no less favorable', 'Employee comparability standard.'),
  phraseEntry('SUBSTANTIALLY_COMPARABLE', 'COV-EMPLOYEE', 'substantially comparable', 'Employee comparability standard.'),
  phraseEntry('INDEMNIFY', 'DNO-INDEM', 'indemnify and hold harmless', 'D&O indemnification covenant.'),
  phraseEntry('ADVANCEMENT', 'DNO-INDEM', 'advancement of expenses', 'D&O advancement covenant.'),
  regexEntry('TAIL', 'DNO-TAIL', '\\btail\\b', 'D&O tail insurance term.'),
  phraseEntry('ANNUAL_PREMIUM', 'DNO-TAIL', 'annual premium', 'D&O tail premium basis.'),
