...
const LEXICAL_FAMILY_LEXICON_VERSION = 16;
...
const ANTI_AGREEMENTS_PHRASES = Object.freeze([
...
].map(([id, value, rationale]) => phraseEntry(id, 'ANTI-AGREEMENTS', value, rationale)));
...
const ANTI_PROCESS_PHRASES = Object.freeze([
  ['COOPERATE', 'ANTI-COOPERATE', 'cooperate and coordinate', 'Grounded regulatory cooperation duty.'],
  ['SUPPLY_INFORMATION', 'ANTI-INFO', 'promptly supply', 'Grounded regulatory information-sharing duty.'],
  ['OUTSIDE_COUNSEL', 'ANTI-INFO', 'outside counsel', 'Grounded information-sharing protection.'],
  ['PROMPTLY_NOTIFY', 'ANTI-NOTIFY', 'promptly notify', 'Grounded regulatory notification duty.'],
  ['KEEP_INFORMED', 'ANTI-NOTIFY', 'keep the other Parties reasonably informed', 'Grounded continuing notification duty.'],
  ['CONTROL_STRATEGY', 'ANTI-STRATEGY', 'right to control', 'Grounded regulatory-strategy control.'],
  ['GOOD_FAITH_COMMENTS', 'ANTI-CONSULT', 'consider in good faith', 'Grounded regulatory consultation right.'],
  ['MATERIALLY_DELAY', 'ANTI-NOACTION', 'materially delaying', 'Grounded non-impediment effect.'],
].map(([id, family, value, rationale]) => phraseEntry(id, family, value, rationale)));
...
const LEXICAL_FAMILY_LEXICON = Object.freeze({
  ...
  entries: Object.freeze([
    ...
    ...ANTI_LITIGATION_PHRASES, ...ANTI_AGREEMENTS_PHRASES, ...ANTI_FILING_ACRONYMS, ...ANTI_FILING_PHRASES, ...ANTI_PROCESS_PHRASES,
