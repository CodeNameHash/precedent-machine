...
const SCHEMA_VERSION = 'NATIVE_PRODUCER_RECORDED_RUN/V2';
...
function createRecordingClient({ client, model = 'default', providerModelId = null, sink }) {
...
function buildRecordingFromSectionFixtures({
  fixtures, orderedSectionRefs, model = 'legacy-fixture', providerModelId = null,
}) {
