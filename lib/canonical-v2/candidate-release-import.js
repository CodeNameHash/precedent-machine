...
function buildCandidateReleaseImportPlan({ release, environment = 'staging' } = {}) {
  ...
  const body = {
    schema_version: 'CANDIDATE_RELEASE_IMPORT_PLAN/V4',
    environment,
  ...
  const plan = Object.freeze({
    ...body,
    candidate_release_import_plan_id: contentId('CANDIDATE_RELEASE_IMPORT_PLAN/V4', body),
  });
...
function validateCandidateReleaseImportPlan(plan) {
  ...
  if (plan.schema_version !== 'CANDIDATE_RELEASE_IMPORT_PLAN/V4' || plan.environment !== 'staging') {
  ...
  if (planId !== contentId('CANDIDATE_RELEASE_IMPORT_PLAN/V4', body)) {
...
function validateCandidateReleaseImportReceipt(receipt, plan) {
  ...
  if (receipt.schema_version !== 'CANDIDATE_RELEASE_IMPORT_RECEIPT/V4'
