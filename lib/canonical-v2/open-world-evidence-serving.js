...
module.exports = {
  ...
  // Exported so callers outside this file can check against the real
  // constant rather than a hand-typed copy of the literal -- PLAN.md Step
  // 2B2's hosted-read drift test (tests/canonical-v2-staging-read-sql-drift.
  // test.js) is why this needed to leave the module: it asserts
  // supabase/canonical-v2-staging-read.sql's own 'CLAIM_REVISION/V1' literal
  // equals THIS constant, not a second hand-typed string that could drift
  // from it unnoticed the same way the marker-absence check drifted from
  // reality on 2026-08-07 (see this file's header).
