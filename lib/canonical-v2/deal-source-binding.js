...
const BINDING_SCHEMA = 'DEAL_SOURCE_BINDING/V1';
...
const BUILD_INPUT_KEYS = Object.freeze([
  ...
  'deal_identity_authority_attestation',
  'capture',
  'conversion',
  'verification',
...
function buildDealSourceBinding(input = {}) {
  ...
  validateDealIdentityAuthorityAttestation({
    attestation: deal_identity_authority_attestation,
    deal_identity_manifest,
  });
  ...
  const body = {
    ...
    deal_identity_authority_attestation_id:
      deal_identity_authority_attestation.deal_identity_authority_attestation_id,
