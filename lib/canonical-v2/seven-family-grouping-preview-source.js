...
const { loadSevenFamilyV2ReviewEvidence } = require('./seven-family-v2-review-evidence');
...
const IOC_PREVIEW_MEASUREMENT_REQUIREMENTS = Object.freeze([
  Object.freeze({ field_key: 'THRESHOLD', label: 'Threshold' }),
  Object.freeze({ field_key: 'EXCEPTION', label: 'Exception' }),
]);
...
const FAMILY_SOURCES = Object.freeze([
  Object.freeze({
    ...
    package: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-dividends-grouping-successor-2026-09-01B.json'),
    ...
    disposition: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-dividends-1-profile-inventory-disposition-grouping-successor-2026-09-01B.json'),
    ...
    seal: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-dividends-grouping-family-package-seal-receipt-2026-09-01B.json'),
  ...
  Object.freeze({
    ...
    package: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-mae-definition-grouping-successor-2026-09-01B.json'),
    ...
    disposition: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-mae-4-profile-inventory-disposition-grouping-successor-2026-09-01B.json'),
    ...
    seal: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-mae-definition-grouping-family-package-seal-receipt-2026-09-01B.json'),
  ...
  Object.freeze({
    ...
    package: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-guaranty-financing-party-grouping-successor-2026-09-01B.json'),
    ...
    disposition: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-guaranty-5-profile-inventory-disposition-grouping-successor-2026-09-01B.json'),
    ...
    seal: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-guaranty-financing-party-grouping-family-package-seal-receipt-2026-09-01B.json'),
    ...
    party_band_order: Object.freeze([null]),
    v1: Object.freeze({
      surface: 'No V1 review-page clause surface',
      rows: Object.freeze([]),
      note: 'Buyer type is deals-index metadata, not a guaranty clause surface.',
    }),
  }),
  Object.freeze({
    ...
    package: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-appraisal-dissenters-rights-grouping-successor-2026-09-01B.json'),
    ...
    disposition: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-appraisal-dissenters-rights-5-profile-inventory-disposition-grouping-successor-2026-09-01B.json'),
    ...
    seal: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-appraisal-dissenters-rights-grouping-family-package-seal-receipt-2026-09-01B.json'),
  ...
  Object.freeze({
    ...
    package: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-financing-covenants-grouping-successor-2026-09-01B.json'),
    ...
    disposition: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-financing-covenants-5-profile-inventory-disposition-grouping-successor-2026-09-01B.json'),
    ...
    seal: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-financing-covenants-grouping-family-package-seal-receipt-2026-09-01B.json'),
  ...
  Object.freeze({
    ...
    package: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-consideration-grouping-successor-2026-09-01B.json'),
    ...
    disposition: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-consideration-7-profile-inventory-disposition-grouping-successor-2026-09-01B.json'),
    ...
    seal: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-consideration-grouping-family-package-seal-receipt-2026-09-01B.json'),
  ...
  Object.freeze({
    ...
    package: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-interim-operating-grouping-successor-2026-09-01B.json'),
    ...
    disposition: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-interim-operating-113-profile-inventory-disposition-grouping-successor-2026-09-01B.json'),
    ...
    seal: Object.freeze({
      ...
      record: require('../../evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-interim-operating-grouping-family-package-seal-receipt-2026-09-01B.json'),
    ...
    measurement_requirements: IOC_PREVIEW_MEASUREMENT_REQUIREMENTS,
    v1: Object.freeze({
...
function readJson(source) {
  ...
  if (!Number.isInteger(source.file) || !source.record || typeof source.record !== 'object') {
    throw new Error(`${source.path} has no readable sealed source`);
  }
  return {
    bytes: Buffer.from(`${JSON.stringify(source.record)}\n`, 'utf8'),
...
function previewMeasurementStatuses(spec) {
  return (spec.measurement_requirements || []).map((requirement) => ({
...
function measurementSummary(rows) {
  ...
  for (const row of rows) {
    for (const profile of row.profiles) profiles.set(profile.profile_key, profile);
  }
  const measuredProfiles = [...profiles.values()].filter(
    (profile) => profile.measurement_statuses.length > 0,
  );
  if (measuredProfiles.length === 0) return null;
  const measurements = measuredProfiles.flatMap((profile) => profile.measurement_statuses);
  const explicitDispositionCount = measurements.filter(
    (measurement) => measurement.disposition !== null,
  ).length;
  const notYetMeasuredCount = measurements.filter(
    (measurement) => measurement.measurement_state === 'NOT_YET_MEASURED',
  ).length;
  return {
    required_disposition_count: measurements.length,
    explicit_disposition_count: explicitDispositionCount,
    not_yet_measured_count: notYetMeasuredCount,
    absent_count: measurements.filter(
      (measurement) => measurement.disposition === 'ABSENT',
    ).length,
    review_only: measuredProfiles.every(
      (profile) => profile.output_disposition === 'REVIEW_ONLY',
    ),
    comparison_complete: measurements.length > 0
      && explicitDispositionCount === measurements.length
      && notYetMeasuredCount === 0,
    product_ready: false,
  };
}

function comparisonRows(spec, disposition, sealedPackage, evidenceByProfileKey) {
  const profilesByKey = new Map(sealedPackage.profiles.map((profile) => [
  ...
  for (const profileDisposition of disposition.profile_dispositions) {
    ...
    for (const candidate of candidates) {
      ...
      row.profile_bands.set(profileDisposition.proposed_profile_key, band);
    }
  }
  const rows = [...grouped.values()].map((row) => {
    ...
    const profiles = [...row.profile_keys].map((profileKey) => {
      const profile = profilesByKey.get(profileKey);
      const reviewEvidence = profile && evidenceByProfileKey.get(profile.profile_key);
      if (!profile || !Array.isArray(profile.classification_path)
        || typeof profile.required_expression_signature !== 'string'
        || profile.required_expression_signature.length === 0
        || !reviewEvidence
        || reviewEvidence.proposed_profile_key !== profileKey
        || JSON.stringify(reviewEvidence.classification_path)
          !== JSON.stringify(profile.classification_path)
        || reviewEvidence.required_expression_signature
          !== profile.required_expression_signature) {
        throw new Error(`${spec.family_key} comparison row has no sealed profile detail`);
      }
      return {
        profile_key: profileKey,
        classification_path: [...profile.classification_path],
        required_expression_signature: profile.required_expression_signature,
        party_band: row.profile_bands.get(profileKey),
        extraction_state: reviewEvidence.extraction_state,
        output_disposition: reviewEvidence.output_disposition,
        source_quality: reviewEvidence.source_quality,
        evidence: reviewEvidence.evidence,
        measurement_statuses: previewMeasurementStatuses(spec),
      };
    });
    return {
...
function loadFamily(spec, familyEvidence) {
  ...
  const evidenceByProfileKey = new Map((familyEvidence?.profiles || []).map((profile) => [
    profile.profile_key,
    profile,
  ]));
  const sealedProfileKeys = new Set(sealedPackage.record.profiles.map((profile) => (
    profile.profile_key
  )));
  if (familyEvidence?.family_key !== spec.family_key
    || familyEvidence.profile_count !== sealedPackage.record.profiles.length
    || evidenceByProfileKey.size !== familyEvidence.profiles.length
    || sealedProfileKeys.size !== sealedPackage.record.profiles.length
    || evidenceByProfileKey.size !== sealedProfileKeys.size
    || [...sealedProfileKeys].some((profileKey) => !evidenceByProfileKey.has(profileKey))) {
    throw new Error(`${spec.family_key} sealed profiles do not match review evidence`);
  }
  const rows = comparisonRows(
    spec,
    disposition.record,
    sealedPackage.record,
    evidenceByProfileKey,
  );
  return {
    ...
    v2_rows: rows,
    measurement_summary: measurementSummary(rows),
...
function loadSevenFamilyGroupingPreview({ env = process.env } = {}) {
  ...
  const reviewEvidence = loadSevenFamilyV2ReviewEvidence();
  const evidenceByFamilyKey = new Map(reviewEvidence.families.map((family) => [
    family.family_key,
    family,
  ]));
  if (evidenceByFamilyKey.size !== reviewEvidence.families.length
    || evidenceByFamilyKey.size !== FAMILY_SOURCES.length
    || FAMILY_SOURCES.some((spec) => !evidenceByFamilyKey.has(spec.family_key))) {
    throw new Error('seven-family preview and review-evidence family sets do not match');
  }
  const families = FAMILY_SOURCES.map((spec) => loadFamily(
    spec,
    evidenceByFamilyKey.get(spec.family_key),
  ));
  return {
    ...
    claim_count: reviewEvidence.claim_count,
    source_only_count: reviewEvidence.source_only_count,
    families,
  };
}
