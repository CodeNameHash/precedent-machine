...
const IDEMPOTENCY_KEY = 'canonical-v2-empty-correction-authority-f4-genesis-v1';

function buildQxoReverseF4AuthorityGenesis() {
  const contractBundle = compileFixtureContractV4();
  if (contractBundle.fingerprint !== QXO_REVERSE_F4_CONTRACT_FINGERPRINT) {
    throw new Error('The F4 contract fingerprint has drifted.');
  }
