...
// Local evidence writers that also inspect repository state through literal,
// read-only Git commands. Kept separate from both LOCAL_ARTIFACT_WRITER and
// READ_ONLY_GIT_INSPECTOR so neither class gains authority it does not use.
