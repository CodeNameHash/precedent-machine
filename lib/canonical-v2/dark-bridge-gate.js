...
class DarkBridgeGateError extends Error {
  constructor(code, message, decision) {
    ...
    // ever sees the throw (the four *-dark-bridge.js modules assert through
    // assertDarkBridgeIntegrationAllowed) can still report WHY the gate said
    // no, not merely that it did.
