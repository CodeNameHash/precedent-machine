...
const DEFINITION_DIGEST =
  '4de604756628d1f20d73fe8df14dac2d96c01e901e304a76be4d61776b4c2c3b';
...
function validateResultDefinition(result) {
  ...
  if (
    ...
    fail(
      code,
      'The Agreement navigation pattern requires target capitalisation result version 3.',
    );
  }
}
