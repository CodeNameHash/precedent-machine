...
const DIRECT_RENDERER_DEPENDENCY_COUNT = 55;
...
function buildRendererDependencyClosure({ repository_root: repositoryRoot } = {}) {
  ...
  if (imports.length !== DIRECT_RENDERER_DEPENDENCY_COUNT) fail('RENDERER_DEPENDENCY_COUNT_DRIFT', 'The V1 review renderer direct dependency closure is no longer 55 entries.');
