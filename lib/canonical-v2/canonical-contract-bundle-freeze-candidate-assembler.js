...
function generatedOutputInventory(compilation, determinismReport) {
...
function assembleCanonicalContractBundleFreezeCandidate(input = {}) {
  ...
  const unsignedReceiptPayload = {
    ...
    contract_bundle_id: firstCompilation.contract_bundle_id,
    contract_bundle_digest: firstCompilation.contract_bundle_digest,
