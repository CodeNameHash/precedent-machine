...
const REVIEWED_SECTIONS = Object.freeze({
  '7.1': Object.freeze({
    title: 'Termination and Abandonment',
    proposal_id: '22ef6007eb38de87d1a0466aaca71df436dc158c0fb29fffe47bb7aaa7f70e14',
    f5_proposal_id: '0da7793fa48fa9b3409ce153d1ba70f6e2df61b4506e0b0512810cc8806c3619',
  }),
  '7.3': Object.freeze({
    title: 'Termination Fee',
    proposal_id: 'a68712360c530682fe7c764705c59be163487b162e172aa5c32ae04c7d42c7bb',
    f5_proposal_id: '78c3a49b90287d997fbe82e94740bbffedbf558cb778aa60b37a5b7dce0f415f',
  }),
});
...
function reviewedSection(envelope, sectionNumber, governedPrecision) {
  ...
  const expectedProposalId = governedPrecision ? expected.f5_proposal_id : expected.proposal_id;
  if (section.section_title !== expected.title
    || section.structural_section_proposal_id !== expectedProposalId) {
...
function buildReviewedTerminationFeeSlice({
  ...
  const section71 = reviewedSection(proposalEnvelope, '7.1', governedPrecision);
  const section73 = reviewedSection(proposalEnvelope, '7.3', governedPrecision);
