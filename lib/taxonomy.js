...
// Two orthogonal axes baked into one code:
//   strength — HARD (no self-termination-for-Superior escape) vs SOFT (escape exists)
//   party    — whose stockholder vote is force-locked: TARGET (the company being
//              acquired), ACQUIRER (the buyer/issuer's own stockholders, e.g. a
//              share-issuance or reverse-merger vote), or BOTH (each side's vote is
//              locked — dual-approval / merger of equals).
// FTV_NONE carries no party: no force-the-vote obligation means no obligated party.
const FORCE_THE_VOTE = {
  FTV_HARD_TARGET: 'Hard force-the-vote, TARGET — the target company\'s stockholder vote survives an Adverse Recommendation Change AND the target has no self-termination right to accept a Superior Proposal (cannot escape the vote by walking away for a competing deal)',
  FTV_HARD_ACQUIRER: 'Hard force-the-vote, ACQUIRER/ISSUER — the acquirer/issuer\'s OWN stockholder vote (e.g. a share-issuance or reverse-merger vote) survives an Adverse Recommendation Change with no self-termination-for-Superior escape for that party',
  FTV_HARD_BOTH: 'Hard force-the-vote, BOTH parties — each party\'s stockholder vote survives an Adverse Recommendation Change and neither has a self-termination-for-Superior escape (dual-approval / merger of equals)',
  FTV_SOFT_TARGET: 'Soft force-the-vote, TARGET — the target\'s vote survives an Adverse Recommendation Change but the target may terminate to accept a Superior Proposal',
  FTV_SOFT_ACQUIRER: 'Soft force-the-vote, ACQUIRER/ISSUER — the acquirer/issuer\'s own vote survives an Adverse Recommendation Change but that party may terminate to accept a Superior Proposal',
  FTV_SOFT_BOTH: 'Soft force-the-vote, BOTH parties — each party\'s vote survives an Adverse Recommendation Change but each retains a Superior-Proposal termination right',
  FTV_NONE: 'No force-the-vote (no vote-survives-recommendation-change covenant on any party)',
};
