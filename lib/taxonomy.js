...
// CVR milestone-payment list items carry one tagged code.
const CVR_MILESTONE_CODES = {
  CVR_MILESTONE: 'CVR milestone payment',
};
...
function taxonomyForFeatureKey(featureKey) {
  switch (featureKey) {
    ...
    case 'cvrMilestonePayments':
      return CVR_MILESTONE_CODES;
