...
const EXCEPTION_CODES = {
  ...
  // Per user: the composite "Section X.YZ of the Disclosure Letter or
  // otherwise expressly required by this Agreement" is ONE canonical pill
  // ("As disclosed"). COMPANY_DISCLOSURE_LETTER is the primary code for this
  // composite phrase; REQUIRED_BY_AGREEMENT is reserved for the rare case
  // when the Agreement-required carve-out appears standalone.
