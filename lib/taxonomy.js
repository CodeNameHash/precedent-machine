...
// Primary dispute forum (concept 17). The exclusivity flag and the ordered
// fallback chain (Chancery -> D. Del. -> DE state) are separate riders.
const PRIMARY_FORUM = {
  DE_CHANCERY: 'Delaware Court of Chancery',
  NY_MANHATTAN: 'New York courts (Borough of Manhattan)',
  MARYLAND_BALTIMORE: 'Circuit Court for Baltimore City',
  FOREIGN_COURT: 'Non-U.S. court',
};
