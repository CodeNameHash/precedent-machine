...
const IOC_CATEGORY_META = {
  ACQUISITIONS: {
    ...
    synonyms: [/acquisitions?/i, /business\s+combinations?/i, /\bm&a\b/i],
  },
  ASSET_SALES_LICENSES: {
    label: 'Asset sales / divestitures / licenses',
    synonyms: [/asset\s+sales?/i, /dispositions?/i, /divestitures?/i, /licenses?\s+(?:of|out)/i],
  },
  INDEBTEDNESS: {
...
const MATERIAL_CONTRACT_BUCKET_META = {
  ...
  SUPPLY: {
    ...
    synonyms: [/supply\s+agreement/i, /supplier\s+contracts?/i],
  },
  MANUFACTURE: {
