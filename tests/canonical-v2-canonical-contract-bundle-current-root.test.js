...
test('assembles the exact current 173-member root into all eight categories', () => {
  ...
  assert.equal(proposal.proposed_dispositions.length, 173);
  assert.equal(proposal.dependency_edge_count, 302);
