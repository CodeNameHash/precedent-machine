...
test('assembles the exact current 167-member root into all eight categories', () => {
  ...
  assert.equal(proposal.proposed_dispositions.length, 167);
  assert.equal(proposal.dependency_edge_count, 265);
