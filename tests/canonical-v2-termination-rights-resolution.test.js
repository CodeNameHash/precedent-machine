...
test('MAPPING_TABLE_VERSION is 12; materiality rank 10 TERMINATION_RIGHTS tier is unchanged and covers every TERMR- concept, including the two new ones', () => {
...
test('additivity re-pin: the resolution receipt threads mapping_table_version 12 and the two new parser versions', async () => {
