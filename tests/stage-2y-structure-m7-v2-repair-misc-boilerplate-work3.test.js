...
let miscBoilerplateAuthoring;
try {
  miscBoilerplateAuthoring = require('../lib/canonical-v2/m7-v2-misc-boilerplate-authoring.js');
} catch (error) {
  throw new Error('MISC_BOILERPLATE Phase2 proposal facade export is missing.');
}
...
for (const facade of [
  ...
  if (typeof miscBoilerplateAuthoring[facade] !== 'function') {
    throw new Error(`MISC_BOILERPLATE ${facade} facade export is missing.`);
  }
}

const PROFILE_COUNT = miscBoilerplateAuthoring.MISC_BOILERPLATE_PROFILE_COUNT;
const FLAGS = miscBoilerplateAuthoring.MISC_BOILERPLATE_REVIEW_FLAGS;
...
const PHASE2_AUTHORITY_BINDING = Object.freeze({
  path: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE2_AUTHORITY_PATH,
  schema_version: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE2_AUTHORITY_SCHEMA,
  record_id_field: 'misc_boilerplate_authoring_phase2_authority_id',
  record_id: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE2_AUTHORITY_ID,
  byte_length: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE2_AUTHORITY_BYTES,
  sha256: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE2_AUTHORITY_SHA256,
});

const PHASE4_AUTHORITY_BINDING = Object.freeze({
  path: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE4_AUTHORITY_PATH,
  schema_version: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE4_AUTHORITY_SCHEMA,
  record_id_field:
    'misc_boilerplate_authoring_phase4_family_profile_package_review_authority_id',
  record_id: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE4_AUTHORITY_ID,
  byte_length: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE4_AUTHORITY_BYTES,
  sha256: miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE4_AUTHORITY_SHA256,
});

const WORK3_BINDINGS = Object.freeze({
  inventoryAuthority: Object.freeze({"byte_length":2134,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-contract-work3-misc-boilerplate-unapproved-inventory-review-authority.json","record_id":"0428eb40c3a9f50c49e6e7e7a6c06cbc48dd81205cdc27c3c68ecb95d16cbef4","record_id_field":"work3_misc_boilerplate_unapproved_inventory_review_authority_id","schema_version":"STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_MISC_BOILERPLATE_UNAPPROVED_INVENTORY_REVIEW_AUTHORITY/V1","sha256":"fd9eee531da1074e7a993c578d5ab20dcf577c3ea8f2a7fac65ddd1aaca2ba2c"}),
  packet: Object.freeze({"byte_length":136861,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-misc-boilerplate-114-profile-inventory-review-packet-draft.json","record_id":"440a469bde98ab29c2953e0067584810859fa33c5e6090260172f1a03ab38267","record_id_field":"inventory_review_packet_id","schema_version":"STAGE_2Y_M7_V2_MISC_BOILERPLATE_114_PROFILE_INVENTORY_REVIEW_PACKET/V1","sha256":"0a6e819bfb9deb4dd619ae7abef36c59f9d0189ded550cbc86146836f709d1c5"}),
  disposition: Object.freeze({"byte_length":46199,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-misc-boilerplate-114-profile-inventory-disposition.json","record_id":"d8bad05c39b5fb080a49de760eae376e6068b7feb7f409266619cf56273fb37c","record_id_field":"inventory_disposition_id","schema_version":"STAGE_2Y_M7_V2_MISC_BOILERPLATE_114_PROFILE_INVENTORY_DISPOSITION/V1","sha256":"90ef3243f75591c70ab5464a33b15c27e9b8736b7df1be4470a569478bb7d0bd"}),
  session: Object.freeze({"byte_length":1133,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-misc-boilerplate-ben-inventory-session-receipt.json","record_id":"dbbafa54bbe5c748ddd87c4527f34e045f3fc9739c46fccd4c42e2c33568a2a2","record_id_field":"ben_inventory_session_receipt_id","schema_version":"STAGE_2Y_M7_V2_MISC_BOILERPLATE_BEN_INVENTORY_SESSION_RECEIPT/V1","sha256":"33ad0736be70f02ed7f908ca7dafcc8bef72a09151de391803ebe000cd880560"}),
  benAuthority: Object.freeze({"byte_length":2829,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-contract-work3-misc-boilerplate-ben-inventory-session-successor-authority.json","record_id":"e48198ced27fec441c96ae9881381c2e2ab6a58e55f28804faad0834797047b8","record_id_field":"work3_misc_boilerplate_ben_inventory_session_successor_authority_id","schema_version":"STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_MISC_BOILERPLATE_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY/V1","sha256":"2d987baa55283c24f4157bb9f74c5ea1fff66db4b515801c7ef39cd29d1eaa3a"}),
  sealAuthority: Object.freeze({"byte_length":3346,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-contract-work3-misc-boilerplate-family-package-seal-successor-authority.json","record_id":"63175830b4ba18cac57c87e407bd9c4aad652eba7f428f53977df892d075ad4a","record_id_field":"work3_misc_boilerplate_family_package_seal_successor_authority_id","schema_version":"STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_MISC_BOILERPLATE_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY/V1","sha256":"ef33f4c17fba24c5bfde749657e6712011d2eca35d75b7c02958bd018b15a9a0"}),
  sealReceipt: Object.freeze({"byte_length":2299,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-misc-boilerplate-family-package-seal-receipt.json","record_id":"dfc53b08fe37bf091e7a8bec778178746b38cd872d89b9906cd7313c3ef66e45","record_id_field":"misc_boilerplate_family_package_seal_receipt_id","schema_version":"STAGE_2Y_M7_V2_MISC_BOILERPLATE_FAMILY_PACKAGE_SEAL_RECEIPT/V1","sha256":"3a1ea1be524951dde0bf1ea848502b5fcf73675c77336fccb992576173d881fc"}),
  registrationAuthority: Object.freeze({"byte_length":2877,"path":"evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-contract-work3-misc-boilerplate-registration-successor-authority.json","record_id":"8a7873dae675acda60225d633882ed22cb6d7d8f8653ff93fc860dc64bbd569b","record_id_field":"work3_misc_boilerplate_registration_successor_authority_id","schema_version":"STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_MISC_BOILERPLATE_REGISTRATION_SUCCESSOR_AUTHORITY/V1","sha256":"b37acd61c252d9493341b06513d184dfc7d079597487f440f323000e08cfaf14"}),
});

const FAMILY_PROFILE_PACKAGE_BINDING = Object.freeze({
  path: 'evidence/canonical-v2/stage-2y-structure-migration/control/m7-v2-repair-family-work3-profile-package-misc-boilerplate.json',
  schema_version: 'STAGE_2Y_M7_V2_FAMILY_PROFILE_PACKAGE/V2',
  record_id_field: 'family_profile_package_id',
  record_id: 'c11d59ec95d42b8a8e359b1a54a5ea71973d7d3b8f841b24f73fc582174f6ebb',
  byte_length: 1418307,
  sha256: 'b137a7efdc75c3f24fd7b1aba3c9a41ad0d21793e44be14c2da233e22018897b',
});
...
function phase2Fixture() {
  ...
  const miscBoilerplateAuthoringPhase2Authority = sourceEnvelope(PHASE2_AUTHORITY_BINDING);
  return {
    miscBoilerplateAuthoringPhase2Authority,
    governedSources: phase2GovernedSources(
      miscBoilerplateAuthoringPhase2Authority.record,
    ),
  };
}
...
function phase4Fixture() {
  ...
  return {
    ...
    miscBoilerplateAuthoringPhase2Authority:
      fixture.miscBoilerplateAuthoringPhase2Authority,
...
test('Phase2 proposal derives a deterministic unapproved MISC_BOILERPLATE partition', () => {
  const fixture = phase2Fixture();
  const authority = fixture.miscBoilerplateAuthoringPhase2Authority.record;
  ...
  assert.deepEqual(
    ...
    sortedUnique(CLASSIFICATION_BUCKETS),
  );
  assert.deepEqual(
  ...
  const result = miscBoilerplateAuthoring
    .prepareMiscBoilerplatePhase2FamilyProposal(fixture);

  assertExactKeys(
    result,
    miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE2_PROPOSAL_KEYS,
    'proposal keys',
  );
  assert.deepEqual({
...
test('Phase2 MISC_BOILERPLATE terminals do not collide with sealed General Covenants M4 claims or M2 nodes', () => {
...
test('Phase4 MISC_BOILERPLATE family profile package review returns unapproved proposals without Work3 identities', () => {
  ...
  const phase2Proposal = miscBoilerplateAuthoring
    .prepareMiscBoilerplatePhase2FamilyProposal({
      miscBoilerplateAuthoringPhase2Authority:
        fixture.miscBoilerplateAuthoringPhase2Authority,
      governedSources: fixture.governedSources,
  ...
  const result = miscBoilerplateAuthoring
    .prepareMiscBoilerplateFamilyProfilePackageReview(fixture);

  assertExactKeys(
    result,
    miscBoilerplateAuthoring.MISC_BOILERPLATE_PHASE4_REVIEW_OUTPUT_KEYS,
  ...
  for (const profile of result.proposed_profiles) {
    ...
    assert.equal(profile.package_profile_key.startsWith('PROFILE:MISC_BOILERPLATE:'), true);
    assert.equal(Object.hasOwn(profile, 'work3_profile_id'), false);
  }
});

test('Work3 MISC_BOILERPLATE unapproved inventory review proves validator acceptance without Work3 identity or package approval', () => {
  ...
  const result = miscBoilerplateAuthoring
    .prepareMiscBoilerplateWork3UnapprovedInventoryReview({
      ...
      miscBoilerplatePhase4ReviewInput: phase4Fixture(),
    });

  assert.equal(
    result.candidate_state,
    'UNAPPROVED_114_PROFILE_INVENTORY_REVIEW_PACKET_ONLY_BEN_APPROVAL_NOT_RECORDED',
  );
  ...
  assert.equal(result.review_accounting.outside_calibration_example_flag_count, 102);
  assert.equal(Object.hasOwn(result, 'family_profile_package_id'), false);
});

test('Work3 MISC_BOILERPLATE Ben inventory session disposition captures Ben-authored file without Work3 identity or package seal', () => {
  ...
  assert.deepEqual(result.disposition_binding.session_summary, {
    ...
    populated_subtype_bucket_count:
      miscBoilerplateAuthoring.MISC_BOILERPLATE_POPULATED_SUBTYPE_BUCKET_COUNT,
    registered_subtype_bucket_count:
      miscBoilerplateAuthoring.MISC_BOILERPLATE_REGISTERED_SUBTYPE_BUCKET_COUNT,
...
test('Work3 MISC_BOILERPLATE family package seal captures Ben seal without Work3 identity or premature registration', () => {
  physicalBytes(WORK3_BINDINGS.session);
  physicalBytes(WORK3_BINDINGS.sealAuthority);
  const evidence = work3Evidence();
  const result = miscBoilerplateAuthoring.prepareMiscBoilerplateWork3FamilyPackageSeal({
...
test('Work3 MISC_BOILERPLATE family package registration binds seal receipt without activation', () => {
  physicalBytes(WORK3_BINDINGS.sealReceipt);
  physicalBytes(WORK3_BINDINGS.registrationAuthority);
  const evidence = work3Evidence();
  const result = miscBoilerplateAuthoring
    .prepareMiscBoilerplateWork3FamilyPackageRegistration({
      miscBoilerplateWork3FamilyPackageRegistrationEvidence: evidence,
      miscBoilerplatePhase4ReviewInput: phase4Fixture(),
    });

  assert.equal(
    result.candidate_state,
    'BEN_MISC_BOILERPLATE_FAMILY_PACKAGE_REGISTERED_ZERO_PRODUCT_WRITE_EFFECT',
  );
...
test('Misc Boilerplate Milestone A inventory packet draft carries shape summaries and honest holds', () => {
  physicalBytes(WORK3_BINDINGS.packet);
...
test('Misc Boilerplate Milestone A disposition approves 114 profiles and reuses only sealed M5 rulings', () => {
  physicalBytes(WORK3_BINDINGS.disposition);
...
test('Misc Boilerplate Milestone A family profile package on disk validates 114 registered profiles', () => {
  ...
  assert.equal(
    ...
    'BEN_APPROVAL:MISC_BOILERPLATE:PROFILE_SET_V1',
  );
  ...
  const phase4 = miscBoilerplateAuthoring
    .prepareMiscBoilerplateFamilyProfilePackageReview(phase4Fixture());
  assert.deepEqual(
...
test('lawful Work3 fixture MISC_BOILERPLATE on-disk override tracks the sealed package bytes', () => {
  ...
  const override = fixture.on_disk_family_package_overrides.find(
    (entry) => entry.family_key === 'MISC_BOILERPLATE',
  );
  assert.ok(override, 'lawful Work3 fixture has no MISC_BOILERPLATE on-disk override');
