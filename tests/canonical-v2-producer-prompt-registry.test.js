...
test('registry: composed adapter prompt families are registered', () => {
  assert.deepEqual(
    listRegisteredSectionFamilies(),
    ['ANTITRUST_REGULATORY', 'APPRAISAL_DISSENTERS_RIGHTS', 'CAPITALISATION', 'CONSIDERATION', 'DIVIDENDS', 'DNO_INDEMNIFICATION', 'EMPLOYEE_MATTERS', 'FINANCING_COVENANTS', 'GUARANTY_FINANCING_PARTY', 'KEY_DEFINED_TERMS', 'MAE_DEFINITION', 'MERGER_STRUCTURE_CLOSING', 'MISC_BOILERPLATE', 'NO_SHOP', 'REPRESENTATIONS', 'SPECIFIC_PERFORMANCE_REMEDIES', 'TAX_MATTERS', 'TERMINATION', 'TERMINATION_FEE'],
  );
});
