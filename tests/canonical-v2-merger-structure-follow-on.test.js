...
assert.strictEqual(output.proposals[0].claim_definition_key, OPEN_WORLD_CLAIM_KEY);
assert.strictEqual(output.proposals[0].raw_value, quote);
assert.strictEqual(output.proposals[0].attributes.why_unmapped, 'SHORT_FORM_251H: DGCL short-form mechanism');
