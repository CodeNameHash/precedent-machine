...
test('current Wave A and follow-on gaps block M3 certification', () => {
  ...
  assert.throws(() => buildM3CertificationControlPlan({
    ...
    error instanceof M3CertificationControlError
      ...
      && error.details.incomplete_families.length === 16
      ...
      && !error.details.incomplete_families.includes('EMPLOYEE_MATTERS')
      && !error.details.incomplete_families.includes('DNO_INDEMNIFICATION')
