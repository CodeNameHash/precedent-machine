...
const { compileFixtureContractV24, compileFixtureContractV30 } = require('../lib/canonical-v2/contract-bundle');
...
test('Antitrust recorded sources and Closing Conditions fixture pack cover the first native slice', () => {
  ...
  const registeredConceptKeys = new Set(compileFixtureContractV30().concepts.map((concept) => concept.concept_key));
