...
test('new submissions default to V1 and switch to V2 with its prompt bundle only when configured', () => {
  ...
  assert.deepEqual(activeSubmissionVersion({ NEXT_PUBLIC_PRODUCT_LEGAL_SCHEMA_VERSION: 'LEGAL_SCHEMA/V2' }), { schemaVersion: 'LEGAL_SCHEMA/V2', promptBundleVersion: 'PRODUCT_LAYERED_COMPONENTS/V9' });
