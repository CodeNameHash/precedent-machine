#!/usr/bin/env node
/**
 * Regenerate the on-disk MISC_BOILERPLATE Work3 family profile package from the
...
const PACKAGE_PATH = `${CONTROL}/m7-v2-repair-family-work3-profile-package-misc-boilerplate.json`;
const WORK3_AUTHORITY_PATH = `${CONTROL}/m7-v2-repair-contract-work3-entry-correction-authority.json`;

const FAMILY_KEY = 'MISC_BOILERPLATE';
...
const APPROVAL_TEXT =
  'Ben approves the MISC_BOILERPLATE 114-profile Work3 package inventory; subtype grouping '
  + 'review pending.';
...
function buildPhase4Review() {
  ...
  return miscBoilerplateAuthoring.prepareMiscBoilerplateFamilyProfilePackageReview({
    miscBoilerplateAuthoringPhase4FamilyProfilePackageReviewAuthority:
      boundEnvelope(PHASE4_BINDING),
    miscBoilerplateAuthoringPhase2Authority: phase2Authority,
