...
function usage() { throw new Error('Usage: node scripts/canonical-v2-prepare-m3-final-pilot-independent-review.mjs --artifact-root <path> [--packet <relative-path>] [--out <relative-path>]'); }
