#!/usr/bin/env node
/**
 * Regenerate the on-disk MATERIAL_CONTRACTS Work3 family profile package from the
...
const PACKAGE_PATH = `${CONTROL}/m7-v2-repair-family-work3-profile-package-material-contracts.json`;
const WORK3_AUTHORITY_PATH = `${CONTROL}/m7-v2-repair-contract-work3-entry-correction-authority.json`;

const FAMILY_KEY = 'MATERIAL_CONTRACTS';
...
const APPROVAL_TEXT =
  'Ben approves the MATERIAL_CONTRACTS 116-profile Work3 package inventory; subtype grouping '
  + 'review pending.';
...
function buildPhase4Review() {
  ...
  return materialContractsAuthoring.prepareMaterialContractsFamilyProfilePackageReview({
    materialContractsAuthoringPhase4FamilyProfilePackageReviewAuthority:
      boundEnvelope(PHASE4_BINDING),
    materialContractsAuthoringPhase2Authority: phase2Authority,
