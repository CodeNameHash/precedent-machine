#!/usr/bin/env node
/**
 * Emit the FINANCING_COVENANTS Ben inventory disposition, session receipt, and the
 ...
 * role schema already binds; no Financing Covenants-specific ruling is invented.
 */
...
const PACKET_PATH =
  `${CONTROL}/m7-v2-repair-financing-covenants-5-profile-inventory-review-packet-draft.json`;
const INVENTORY_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-financing-covenants-unapproved-inventory-review-authority.json`;
const DISPOSITION_PATH =
  `${CONTROL}/m7-v2-repair-financing-covenants-5-profile-inventory-disposition.json`;
const SESSION_PATH =
  `${CONTROL}/m7-v2-repair-financing-covenants-ben-inventory-session-receipt.json`;
const BEN_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-financing-covenants-ben-inventory-session-successor-authority.json`;
const SEAL_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-financing-covenants-family-package-seal-successor-authority.json`;
const SEAL_RECEIPT_PATH =
  `${CONTROL}/m7-v2-repair-financing-covenants-family-package-seal-receipt.json`;
const REGISTRATION_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-financing-covenants-registration-successor-authority.json`;
const RULINGS_PATH = `${CONTROL}/m5-programme-rulings.json`;
const ROLE_SCHEMA_PATH = `${CONTROL}/family-role-schemas/FINANCING_COVENANTS.json`;

const DISPOSITION_SCHEMA =
  'STAGE_2Y_M7_V2_FINANCING_COVENANTS_5_PROFILE_INVENTORY_DISPOSITION/V1';
const SESSION_SCHEMA =
  'STAGE_2Y_M7_V2_FINANCING_COVENANTS_BEN_INVENTORY_SESSION_RECEIPT/V1';
const BEN_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_FINANCING_COVENANTS_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY/V1';
const SEAL_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_FINANCING_COVENANTS_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY/V1';
const SEAL_RECEIPT_SCHEMA =
  'STAGE_2Y_M7_V2_FINANCING_COVENANTS_FAMILY_PACKAGE_SEAL_RECEIPT/V1';
const REGISTRATION_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_FINANCING_COVENANTS_REGISTRATION_SUCCESSOR_AUTHORITY/V1';
const SEAL_CANDIDATE_SCHEMA =
  'M7_V2_FINANCING_COVENANTS_WORK3_FAMILY_PACKAGE_SEAL_CANDIDATE/V1';
...
const SEAL_CANDIDATE_STATE =
  'BEN_FINANCING_COVENANTS_FAMILY_PACKAGE_SEAL_CAPTURED_REGISTRATION_NOT_RECORDED';
...
const DIVERGENCE_COUNT =
  financingCovenantsAuthoring.FINANCING_COVENANTS_SUBTYPE_DIVERGENCE_PROFILE_COUNT;
const OUTSIDE_CALIBRATION_COUNT =
  financingCovenantsAuthoring.FINANCING_COVENANTS_OUTSIDE_CALIBRATION_PROFILE_COUNT;
const REGISTERED_BUCKETS =
  financingCovenantsAuthoring.FINANCING_COVENANTS_REGISTERED_SUBTYPE_BUCKET_COUNT;
const POPULATED_BUCKETS =
  financingCovenantsAuthoring.FINANCING_COVENANTS_POPULATED_SUBTYPE_BUCKET_COUNT;
...
const inventoryAuthorityBinding = binding(
  ...
  inventoryAuthority,
  'work3_financing_covenants_unapproved_inventory_review_authority_id',
);
...
const sessionUnsigned = {
  ...
  session_classification: 'FINANCING_COVENANTS_5_PROFILE_INVENTORY_BEN_REVIEW',
...
const benAuthority = authority(
  ...
  'work3_financing_covenants_ben_inventory_session_successor_authority_id',
  {
    authority_classification:
      'WORK3_FINANCING_COVENANTS_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareFinancingCovenantsWork3BenInventorySessionDisposition',
    ...
    schema_review_candidate_contract: {
      schema_version:
        'M7_V2_FINANCING_COVENANTS_WORK3_BEN_INVENTORY_SESSION_DISPOSITION_CANDIDATE/V1',
...
const sealAuthority = authority(
  ...
  'work3_financing_covenants_family_package_seal_successor_authority_id',
  {
    authority_classification: 'WORK3_FINANCING_COVENANTS_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareFinancingCovenantsWork3FamilyPackageSeal',
      exact_outer_input_keys: [
...
// Mirrors prepareFinancingCovenantsWork3FamilyPackageSeal exactly; the test asserts
...
const sealReceiptUnsigned = {
  ...
  seal_classification: 'FINANCING_COVENANTS_WORK3_FAMILY_PACKAGE_SEAL',
  completion_state: 'COMPLETE',
  reviewer: 'BEN_GOODCHILD',
...
const sealReceipt = {
  ...sealReceiptUnsigned,
  financing_covenants_family_package_seal_receipt_id:
...
const registrationAuthority = authority(
  ...
  'work3_financing_covenants_registration_successor_authority_id',
  {
    authority_classification: 'WORK3_FINANCING_COVENANTS_REGISTRATION_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareFinancingCovenantsWork3FamilyPackageRegistration',
      exact_outer_input_keys: [
    ...
    schema_review_candidate_contract: {
      schema_version: 'M7_V2_FINANCING_COVENANTS_WORK3_FAMILY_PACKAGE_REGISTRATION_CANDIDATE/V1',
      candidate_state:
