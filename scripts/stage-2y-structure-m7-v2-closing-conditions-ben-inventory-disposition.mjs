...
const DISPOSITION_PATH =
  `${CONTROL}/m7-v2-repair-closing-conditions-57-profile-inventory-disposition.json`;
const SESSION_PATH =
  `${CONTROL}/m7-v2-repair-closing-conditions-ben-inventory-session-receipt.json`;
const BEN_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-closing-conditions-ben-inventory-session-successor-authority.json`;
const SEAL_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-closing-conditions-family-package-seal-successor-authority.json`;
const SEAL_RECEIPT_PATH =
  `${CONTROL}/m7-v2-repair-closing-conditions-family-package-seal-receipt.json`;
const REGISTRATION_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-closing-conditions-registration-successor-authority.json`;
const RULINGS_PATH =
  'docs/codex-program/notes/CLOSING-CONDITIONS-BEN-RULINGS-Q01-Q03-2026-08-24.md';
const DISPOSITION_SCHEMA =
  'STAGE_2Y_M7_V2_CLOSING_CONDITIONS_57_PROFILE_INVENTORY_DISPOSITION/V1';
const SESSION_SCHEMA =
  'STAGE_2Y_M7_V2_CLOSING_CONDITIONS_BEN_INVENTORY_SESSION_RECEIPT/V1';
const BEN_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_CLOSING_CONDITIONS_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY/V1';
const SEAL_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_CLOSING_CONDITIONS_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY/V1';
const SEAL_RECEIPT_SCHEMA =
  'STAGE_2Y_M7_V2_CLOSING_CONDITIONS_FAMILY_PACKAGE_SEAL_RECEIPT/V1';
const REGISTRATION_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_CLOSING_CONDITIONS_REGISTRATION_SUCCESSOR_AUTHORITY/V1';
const SEAL_CANDIDATE_SCHEMA =
  'M7_V2_CLOSING_CONDITIONS_WORK3_FAMILY_PACKAGE_SEAL_CANDIDATE/V1';
const DISPOSITION_CANDIDATE_STATE =
  'BEN_57_PROFILE_INVENTORY_DISPOSITION_CAPTURED_PACKAGE_SEAL_NOT_RECORDED';
...
const sessionUnsigned = {
  ...
  session_classification: 'CLOSING_CONDITIONS_57_PROFILE_INVENTORY_BEN_REVIEW',
...
const benAuthority = authority(
  ...
  'work3_closing_conditions_ben_inventory_session_successor_authority_id',
  {
    authority_classification:
      'WORK3_CLOSING_CONDITIONS_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY',
    authority_state:
    ...
    implementation_contract: {
      exported_function: 'prepareClosingConditionsWork3BenInventorySessionDisposition',
    ...
    schema_review_candidate_contract: {
      schema_version:
        'M7_V2_CLOSING_CONDITIONS_WORK3_BEN_INVENTORY_SESSION_DISPOSITION_CANDIDATE/V1',
...
const sealAuthority = authority(
  ...
  'work3_closing_conditions_family_package_seal_successor_authority_id',
  {
    authority_classification: 'WORK3_CLOSING_CONDITIONS_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareClosingConditionsWork3FamilyPackageSeal',
      exact_outer_input_keys: [
    ...
    schema_review_candidate_contract: {
      ...
      candidate_state:
        'BEN_CLOSING_CONDITIONS_FAMILY_PACKAGE_SEAL_CAPTURED_REGISTRATION_NOT_RECORDED',
      review_accounting_exact_values: {
        inventory_review_count: 1,
...
const sealReceiptUnsigned = {
  ...
  seal_classification: 'CLOSING_CONDITIONS_WORK3_FAMILY_PACKAGE_SEAL',
  completion_state: 'COMPLETE',
  reviewer: 'BEN_GOODCHILD',
...
const sealReceipt = {
  ...sealReceiptUnsigned,
  closing_conditions_family_package_seal_receipt_id:
...
const registrationAuthority = authority(
  ...
  'work3_closing_conditions_registration_successor_authority_id',
  {
    authority_classification: 'WORK3_CLOSING_CONDITIONS_REGISTRATION_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareClosingConditionsWork3FamilyPackageRegistration',
      exact_outer_input_keys: [
    ...
    schema_review_candidate_contract: {
      schema_version: 'M7_V2_CLOSING_CONDITIONS_WORK3_FAMILY_PACKAGE_REGISTRATION_CANDIDATE/V1',
      candidate_state:
