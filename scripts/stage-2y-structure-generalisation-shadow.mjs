...
// Two gates, both routing a proposition out of the normal comparison lane and
// into review: structure ambiguity, and an authored unit reached by document
// order rather than by matching the family.
