...
const DISPOSITION_PATH =
  `${CONTROL}/m7-v2-repair-general-covenants-54-profile-inventory-disposition.json`;
const SESSION_PATH =
  `${CONTROL}/m7-v2-repair-general-covenants-ben-inventory-session-receipt.json`;
...
const SEAL_RECEIPT_PATH =
  `${CONTROL}/m7-v2-repair-general-covenants-family-package-seal-receipt.json`;
...
const RULINGS_PATH =
  'docs/codex-program/notes/GENERAL-COVENANTS-BEN-RULINGS-Q01-Q03-2026-08-24.md';
const DISPOSITION_SCHEMA =
  'STAGE_2Y_M7_V2_GENERAL_COVENANTS_54_PROFILE_INVENTORY_DISPOSITION/V1';
const SESSION_SCHEMA =
  'STAGE_2Y_M7_V2_GENERAL_COVENANTS_BEN_INVENTORY_SESSION_RECEIPT/V1';
...
const SEAL_RECEIPT_SCHEMA =
  'STAGE_2Y_M7_V2_GENERAL_COVENANTS_FAMILY_PACKAGE_SEAL_RECEIPT/V1';
...
const SEAL_CANDIDATE_SCHEMA =
  'M7_V2_GENERAL_COVENANTS_WORK3_FAMILY_PACKAGE_SEAL_CANDIDATE/V1';
...
const accessScopeFlagCount = packet.profile_review_items.filter((item) => (
...
const profileDispositions = packet.profile_review_items.map((item) => ({
  ...
  access_scope_item_44_acknowledged: item.review_flags.includes(
...
const dispositionUnsigned = {
  ...
  session_summary: {
    ...
    reject_count: 0,
    partial_count: 0,
    access_scope_item_44_acknowledged_count: accessScopeFlagCount,
...
const sessionUnsigned = {
  ...
  session_classification: 'GENERAL_COVENANTS_54_PROFILE_INVENTORY_BEN_REVIEW',
...
const benAuthority = authority(
  ...
  'work3_general_covenants_ben_inventory_session_successor_authority_id',
  {
    authority_classification: 'WORK3_GENERAL_COVENANTS_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY',
    authority_state:
    ...
    implementation_contract: {
      exported_function: 'prepareGeneralCovenantsWork3BenInventorySessionDisposition',
    ...
    schema_review_candidate_contract: {
      schema_version:
        'M7_V2_GENERAL_COVENANTS_WORK3_BEN_INVENTORY_SESSION_DISPOSITION_CANDIDATE/V1',
      candidate_state:
        'BEN_54_PROFILE_INVENTORY_DISPOSITION_CAPTURED_PACKAGE_SEAL_NOT_RECORDED',
...
const accessScopeBinding = {
  ...rulingsBinding,
  disposition_status: 'DEFERRED',
  access_scope_item_44_review_count: accessScopeFlagCount,
};
const sealAuthority = authority(
  SEAL_AUTHORITY_SCHEMA,
  'work3_general_covenants_family_package_seal_successor_authority_id',
  {
    authority_classification: 'WORK3_GENERAL_COVENANTS_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareGeneralCovenantsWork3FamilyPackageSeal',
      exact_outer_input_keys: [
    ...
    schema_review_candidate_contract: {
      ...
      candidate_state:
        'BEN_GENERAL_COVENANTS_FAMILY_PACKAGE_SEAL_CAPTURED_REGISTRATION_NOT_RECORDED',
      review_accounting_exact_values: {
        inventory_review_count: 1,
...
const sealUnsigned = {
  ...
  access_scope_disposition_binding: accessScopeBinding,
...
const sealReceiptUnsigned = {
  ...
  seal_classification: 'GENERAL_COVENANTS_WORK3_FAMILY_PACKAGE_SEAL',
  completion_state: 'COMPLETE',
  reviewer: 'BEN_GOODCHILD',
...
const sealReceipt = {
  ...sealReceiptUnsigned,
  general_covenants_family_package_seal_receipt_id:
...
const registrationAuthority = authority(
  ...
  'work3_general_covenants_registration_successor_authority_id',
  {
    authority_classification: 'WORK3_GENERAL_COVENANTS_REGISTRATION_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareGeneralCovenantsWork3FamilyPackageRegistration',
      exact_outer_input_keys: [
    ...
    schema_review_candidate_contract: {
      schema_version: 'M7_V2_GENERAL_COVENANTS_WORK3_FAMILY_PACKAGE_REGISTRATION_CANDIDATE/V1',
      candidate_state:
      ...
      review_accounting_exact_values: {
        ...
        profile_disposition_count: 54,
        profile_identity_count: 54,
        registration_count: 1,
        runtime_validator_acceptance_count: 1,
        work3_identity_count: 55,
      },
    },
    zero_effect_boundary: {
      activation_count: 0,
...
console.log(JSON.stringify({
  ...
  family_package_seal_id: familyPackageSealId,
  access_scope_flag_count: accessScopeFlagCount,
