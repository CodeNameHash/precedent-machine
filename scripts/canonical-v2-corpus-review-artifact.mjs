...
function buildCorpusReviewModel({ repoRoot = DEFAULT_ROOT, runNames = null } = {}) {
  ...
  for (const name of names) {
    ...
    runs.push(Object.freeze({
      ...
      claims: attempted.map((item, index) => Object.freeze({
        run: name,
        deal: manifest.deal,
        family: manifest.section_family,
...
<h2>Claims grouped by excerpt</h2><div class="cards">${cards}</div></main></body></html>`;
}
