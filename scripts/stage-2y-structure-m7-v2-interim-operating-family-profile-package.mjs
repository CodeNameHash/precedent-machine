#!/usr/bin/env node
/**
 * Regenerate the on-disk INTERIM_OPERATING Work3 family profile package from the
...
const PACKAGE_PATH = `${CONTROL}/m7-v2-repair-family-work3-profile-package-interim-operating.json`;
const WORK3_AUTHORITY_PATH = `${CONTROL}/m7-v2-repair-contract-work3-entry-correction-authority.json`;

const FAMILY_KEY = 'INTERIM_OPERATING';
...
const APPROVAL_TEXT =
  'Ben approves the INTERIM_OPERATING 113-profile Work3 package inventory; subtype grouping '
  + 'review pending.';
...
function buildPhase4Review() {
  ...
  return interimOperatingAuthoring.prepareInterimOperatingFamilyProfilePackageReview({
    interimOperatingAuthoringPhase4FamilyProfilePackageReviewAuthority:
      boundEnvelope(PHASE4_BINDING),
    interimOperatingAuthoringPhase2Authority: phase2Authority,
