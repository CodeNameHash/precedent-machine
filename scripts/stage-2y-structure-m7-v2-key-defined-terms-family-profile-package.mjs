#!/usr/bin/env node
/**
 * Regenerate the on-disk KEY_DEFINED_TERMS Work3 family profile package from the
...
const PACKAGE_PATH = `${CONTROL}/m7-v2-repair-family-work3-profile-package-key-defined-terms.json`;
const WORK3_AUTHORITY_PATH = `${CONTROL}/m7-v2-repair-contract-work3-entry-correction-authority.json`;

const FAMILY_KEY = 'KEY_DEFINED_TERMS';
...
const APPROVAL_TEXT =
  'Ben approves the KEY_DEFINED_TERMS 76-profile Work3 package inventory; subtype grouping '
  + 'review pending.';
...
function buildPhase4Review() {
  ...
  return keyDefinedTermsAuthoring.prepareKeyDefinedTermsFamilyProfilePackageReview({
    keyDefinedTermsAuthoringPhase4FamilyProfilePackageReviewAuthority:
      boundEnvelope(PHASE4_BINDING),
    keyDefinedTermsAuthoringPhase2Authority: phase2Authority,
