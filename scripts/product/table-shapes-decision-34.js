...
const CAPITALIZATION_ROWS = ['Common Stock', 'Preferred Stock', 'Company Stock Options', 'Company RSUs', 'Company PSUs', 'Company Restricted Stock Awards', 'ESPP', 'Warrants', 'Merger Sub capital stock', 'Subsidiary equity'];
