#!/usr/bin/env node
/**
 * Regenerate the on-disk MERGER_STRUCTURE_CLOSING Work3 family profile package from the
...
const PACKAGE_PATH = `${CONTROL}/m7-v2-repair-family-work3-profile-package-merger-structure-closing.json`;
const WORK3_AUTHORITY_PATH = `${CONTROL}/m7-v2-repair-contract-work3-entry-correction-authority.json`;

const FAMILY_KEY = 'MERGER_STRUCTURE_CLOSING';
...
const APPROVAL_TEXT =
  'Ben approves the MERGER_STRUCTURE_CLOSING 103-profile Work3 package inventory; subtype grouping '
  + 'review pending.';
...
function buildPhase4Review() {
  ...
  return mergerStructureClosingAuthoring.prepareMergerStructureClosingFamilyProfilePackageReview({
    mergerStructureClosingAuthoringPhase4FamilyProfilePackageReviewAuthority:
      boundEnvelope(PHASE4_BINDING),
    mergerStructureClosingAuthoringPhase2Authority: phase2Authority,
