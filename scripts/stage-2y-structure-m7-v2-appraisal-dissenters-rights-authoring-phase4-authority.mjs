#!/usr/bin/env node
/**
 * Emit APPRAISAL_DISSENTERS_RIGHTS Phase 4 family profile package review authority from
...
const SCHEMA = appraisalDissentersRightsAuthoring.APPRAISAL_DISSENTERS_RIGHTS_PHASE4_AUTHORITY_SCHEMA;
const OUT_PATH = appraisalDissentersRightsAuthoring.APPRAISAL_DISSENTERS_RIGHTS_PHASE4_AUTHORITY_PATH;
...
const TEST_PATH = 'tests/stage-2y-structure-m7-v2-repair-appraisal-dissenters-rights-work3.test.js';
...
function phase2Fixture() {
  const appraisalDissentersRightsAuthoringPhase2Authority = sourceEnvelope(PHASE2_BINDING);
  const authority = appraisalDissentersRightsAuthoringPhase2Authority.record;
...
function main() {
  ...
  const terminalsBySourceUnitKey = new Map(
    fixture.appraisalDissentersRightsAuthoringPhase2Authority.record
  ...
  const unsigned = {
    ...
    design_basis: {
      ...
      public_facade: 'prepareAppraisalDissentersRightsFamilyProfilePackageReview',
      public_input_key_count: 3,
    },
    immutable_parent_bindings: {
      appraisal_dissenters_rights_authoring_phase2_authority: PHASE2_BINDING,
    },
    implementation_contract: {
      ...
      error_precedence: [
        {
          code: 'M7_V2_APPRAISAL_DISSENTERS_RIGHTS_PHASE4_REVIEW_CONTRACT',
          condition: 'NULL_NON_OBJECT_MISSING_EXTRA_OR_REORDERED_OUTER_INPUT_KEYS',
          order: 1,
        },
        {
          code: 'M7_V2_APPRAISAL_DISSENTERS_RIGHTS_PHASE4_REVIEW_AUTHORITY',
          condition: 'AUTHORITY_ENVELOPE_BINDING_PHYSICAL_BYTES_SELF_ID_OR_PARENT_PIN_DRIFT',
          order: 2,
        },
        {
          code: 'M7_V2_APPRAISAL_DISSENTERS_RIGHTS_PHASE4_PHASE2_PROPOSAL',
          condition: 'FRESH_PHASE2_PROPOSAL_FAILS_OR_5_PROFILE_BINDING_DRIFTS',
          order: 3,
        },
        {
          code: 'M7_V2_APPRAISAL_DISSENTERS_RIGHTS_PHASE4_PROFILE_SCHEDULE',
          condition: 'TUPLE_PROFILE_SOURCE_CLAIM_OR_PROFILE_ORDER_DRIFT',
          order: 4,
        },
        {
          code: 'M7_V2_APPRAISAL_DISSENTERS_RIGHTS_PHASE4_REVIEW_OUTPUT',
      ...
      exported_function: 'prepareAppraisalDissentersRightsFamilyProfilePackageReview',
      module_path: MODULE_PATH,
      phase2_internal_function: 'prepareAppraisalDissentersRightsPhase2FamilyProposal',
    ...
    candidate_output_contract: {
      candidate_state: appraisalDissentersRightsAuthoring.APPRAISAL_DISSENTERS_RIGHTS_PHASE4_CANDIDATE_STATE,
      exact_keys: [
      ...
      schema_version:
        appraisalDissentersRightsAuthoring.APPRAISAL_DISSENTERS_RIGHTS_PHASE4_CANDIDATE_SCHEMA,
      unresolved_items: [
    ...
    execution_schedule: {
      ...
      focused_test_name:
        'Phase4 APPRAISAL_DISSENTERS_RIGHTS family profile package review returns unapproved proposals without Work3 identities',
  ...
  const record = {
    ...unsigned,
    appraisal_dissenters_rights_authoring_phase4_family_profile_package_review_authority_id: recordId,
  };
