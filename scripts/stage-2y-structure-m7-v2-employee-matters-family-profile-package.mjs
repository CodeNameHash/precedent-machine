#!/usr/bin/env node
/**
 * Regenerate the on-disk EMPLOYEE_MATTERS Work3 family profile package from the
...
const PACKAGE_PATH = `${CONTROL}/m7-v2-repair-family-work3-profile-package-employee-matters.json`;
const WORK3_AUTHORITY_PATH = `${CONTROL}/m7-v2-repair-contract-work3-entry-correction-authority.json`;

const FAMILY_KEY = 'EMPLOYEE_MATTERS';
...
const APPROVAL_TEXT =
  'Ben approves the EMPLOYEE_MATTERS 27-profile Work3 package inventory; subtype grouping '
  + 'review pending.';
...
function buildPhase4Review() {
  ...
  return employeeMattersAuthoring.prepareEmployeeMattersFamilyProfilePackageReview({
    employeeMattersAuthoringPhase4FamilyProfilePackageReviewAuthority:
      boundEnvelope(PHASE4_BINDING),
    employeeMattersAuthoringPhase2Authority: phase2Authority,
