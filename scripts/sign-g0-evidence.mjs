...
const OWNER_AUTHORITY_ALLOWED_PATHS = Object.freeze([
  ...
  '.github/phase-allowlists/wp-p8-stage4-agreement-v3-release-authority-v1.json',
  '.github/phase-allowlists/wp-p8-stage4-ioc-sql-parity-v1.json',
  ...
  '.github/phase-allowlists/wp-p8-stage4-product-query-cache-v1.json',
  ...
  '.github/phase-allowlists/wp-p8-stage4-review-correction-integration-v1.json',
  '.github/phase-allowlists/wp-p8-stage4-staging-proof-integration-v1.json',
  '.github/phase-allowlists/wp-p8-stage4-sql-root-pins-v1.json',
  '.github/phase-allowlists/wp-p8-stage5-candidate-reconciliation-v1.json',
  ...
  '.github/phase-allowlists/wp-p1-pilot-freeze-root-integration-v1.json',
  '.github/phase-allowlists/wp-p1-pilot-freeze-test-reconciliation-v2.json',
  '.github/phase-allowlists/wp-p1-product-query-serving-contracts-v1.json',
  '.github/phase-allowlists/wp-p1-product-query-serving-contracts-v2.json',
  '.github/phase-allowlists/wp-p1-qxo-golden-f28-correction-v1.json',
  '.github/phase-allowlists/wp-p1-termination-fee-market-metric-definitions-v1.json',
  ...
  'contracts/canonical-v2/successor/agreement/market-metric-definitions/buyer-termination-fee-percent-of-deal-value.v1.json',
  'contracts/canonical-v2/successor/agreement/market-metric-definitions/ioc-capex-threshold-percent-of-deal-value.v1.json',
  'contracts/canonical-v2/successor/agreement/market-metric-definitions/no-shop-copy-delivery-period-days.v1.json',
  'contracts/canonical-v2/successor/agreement/market-metric-definitions/no-shop-initial-match-period-days.v1.json',
  'contracts/canonical-v2/successor/agreement/market-metric-definitions/seller-termination-fee-percent-of-deal-value.v1.json',
  'contracts/canonical-v2/successor/agreement/result-definitions/buyer-initial-match-right.v1.json',
  ...
  'contracts/canonical-v2/successor/product/query/product-query-serving-execution.v1.json',
  'contracts/canonical-v2/successor/product/query/product-shared-serving-row.v1.json',
  'lib/canonical-v2/canonical-contract-bundle-generated-topology.js',
  'lib/canonical-v2/canonical-contract-excepted-by-validator.js',
  'lib/canonical-v2/canonical-contract-remaining-migration-input-validator.js',
  'lib/canonical-v2/canonical-contract-no-shop-schema-input-validator.js',
  'lib/canonical-v2/governed-residual-contract-input-validator.js',
  'lib/canonical-v2/pilot-market-metric-contract-input-validator.js',
  'lib/canonical-v2/pilot-result-definition-input-validator.js',
  'lib/canonical-v2/product-serving-contract-input-validator.js',
  'tests/canonical-v2-canonical-contract-bundle-generated-topology.test.js',
  'tests/canonical-v2-governed-residual-contract-input.test.js',
  'tests/canonical-v2-pilot-market-metric-contract-input.test.js',
  'tests/canonical-v2-pilot-result-definition-input.test.js',
  'tests/canonical-v2-product-serving-contract-input.test.js',
  '.github/phase-allowlists/wp-agreement-candidate-envelope-v1.json',
  ...
  '.github/phase-allowlists/wp-p8-agreement-capex-predicate-navigation-v1.json',
  '.github/phase-allowlists/wp-p8-agreement-domain-result-adapter-v1.json',
  '.github/phase-allowlists/wp-p8-agreement-materialisation-stage3-correction-v1.json',
  '.github/phase-allowlists/wp-p8-agreement-product-action-profile-v1.json',
  '.github/phase-allowlists/wp-p8-agreement-product-central-integration-v1.json',
  ...
  '.github/phase-allowlists/wp-p8-agreement-writer-sql-native-validator-v1.json',
  '.github/phase-allowlists/wp-p8-agreement-writer-sql-stage3-correction-v1.json',
  '.github/phase-allowlists/wp-p8-exact-bundle-permission-v1.json',
  '.github/phase-allowlists/wp-p8-generic-agreement-ordering-presentation-v1.json',
  '.github/phase-allowlists/wp-p8-generic-writer-correction.json',
  '.github/phase-allowlists/wp-p8-m1-bundle-approval-wiring-v1.json',
  '.github/phase-allowlists/wp-p8-metsera-authority-context-propagation-v1.json',
  '.github/phase-allowlists/wp-p8-metsera-prewrite-authority-correction-v1.json',
  '.github/phase-allowlists/wp-p8-metsera-product-query-context-v1.json',
  '.github/phase-allowlists/wp-p8-milestone-mechanical-bindings-v1.json',
  '.github/phase-allowlists/wp-p8-process-admission-validation-membership-v1.json',
  '.github/phase-allowlists/wp-p8-process-pipeline-integration-corrections-v1.json',
  '.github/phase-allowlists/wp-p8-process-prewrite-product-bridge-v1.json',
  '.github/phase-allowlists/wp-p8-product-authority-context-v1.json',
  '.github/phase-allowlists/wp-p8-product-release-hardening-v1.json',
  '.github/phase-allowlists/wp-p8-product-release-mechanical-bindings-v1.json',
  '.github/phase-allowlists/wp-p8-product-surface-binding-v1.json',
  '.github/phase-allowlists/wp-p8-signer-path-closure-v1.json',
  '.github/phase-allowlists/wp-p8-stage4-ioc-subject-cohort-inclusion-v1.json',
  '.github/phase-allowlists/wp-process-acquisition-trusted-receipt-anchor-v1.json',
  '.github/phase-allowlists/wp-process-enumerator-external-scope-anchor-v1.json',
  '.github/phase-allowlists/wp-process-enumerator-scope-identity-corrections-v1.json',
  '.github/phase-allowlists/wp-process-enumerator-trusted-scope-anchor-v1.json',
  '.github/phase-allowlists/wp-process-exclusivity-pilot-pipeline-v1.json',
  '.github/phase-allowlists/wp-process-semantic-outcome-graph-compatibility-v1.json',
  '.github/phase-allowlists/wp-process-source-acquisition-receipt-hardening-v1.json',
  '.github/phase-allowlists/wp-product-candidate-result-writer-v1.json',
  '.github/phase-allowlists/wp-product-query-result-release-import-serving-v1.json',
  '.github/phase-allowlists/wp-product-query-result-release-partition-v1.json',
  '.github/phase-allowlists/wp-product-query-result-serving-projection-v1.json',
  '.github/phase-allowlists/wp-qxo-capitalisation-f28-admitted-source-identity-v1.json',
  '.github/phase-allowlists/wp-qxo-capitalisation-f28-parameterised-envelope-v1.json',
  '.github/phase-allowlists/wp-qxo-capitalisation-f28-pilot-preflight-v1.json',
  '.github/phase-allowlists/wp-qxo-capitalisation-f28-stage4-corrections-v1.json',
  '.github/phase-allowlists/wp-qxo-f28-m1-permission-v1.json',
  ...
  'contracts/canonical-v2/successor/product/query/product-query-result-serving-projection.v1.json',
  ...
  'lib/canonical-v2/agreement-candidate-domain-result-adapter.js',
  'lib/canonical-v2/agreement-candidate-envelope-contract-input-validator.js',
  'lib/canonical-v2/agreement-candidate-envelope.js',
  'lib/canonical-v2/agreement-candidate-product-materialisation.js',
  'lib/canonical-v2/candidate-release-import.js',
  ...
  'lib/canonical-v2/metsera-exclusivity-product-source-reader.js',
  ...
  'lib/canonical-v2/pilot-product-authority-context.js',
  'lib/canonical-v2/pilot-product-field-catalogue.js',
  'lib/canonical-v2/process-exclusivity-pilot-pipeline.js',
  'lib/canonical-v2/product-candidate-result-write.js',
  'lib/canonical-v2/product-candidate-write-contract-input-validator.js',
  'lib/canonical-v2/product-query-result-active-serving.js',
  'lib/canonical-v2/product-query-result-release-partition.js',
  ...
  'lib/canonical-v2/qxo-capitalisation-f28-candidate-envelope-contract-input-validator.js',
  'lib/canonical-v2/qxo-capitalisation-f28-candidate-envelope.js',
  'lib/canonical-v2/qxo-capitalisation-f28-pilot-preflight.js',
  'lib/canonical-v2/qxo-capitalisation-f28-product-result-adapter-v2-contract-input-validator.js',
  'lib/canonical-v2/qxo-capitalisation-f28-product-surfaces.js',
  'lib/canonical-v2/qxo-capitalisation-f28-runtime-link.js',
  'lib/canonical-v2/qxo-capitalisation-f28-writer-link.js',
  'lib/canonical-v2/qxo-no-shop-inline-permission-f9.js',
  'lib/canonical-v2/reviewed-ioc-capex-slice.js',
  'lib/canonical-v2/serving-client.js',
  'lib/canonical-v2/shared-row-adapter.js',
  'lib/canonical-v2/shared-serving-row.js',
  'lib/canonical-v2/validate-write-set.js',
  'lib/programme-gates/m1-milestone-permission.js',
  'lib/schema/canonical/contract-v2/no-shop-semantic-schema-inputs/no-shop-exception-effect.v1.json',
  'lib/schema/canonical/contract-v2/no-shop-semantic-schema-inputs/no-shop-inline-permission-effect.v1.json',
  'lib/schema/canonical/contract-v2/no-shop-semantic-schema-inputs/no-shop-notice-obligation.v6.json',
  'lib/schema/canonical/contract-v2/serving-metric-operation-binding-inputs/buyer-termination-fee-percent-of-deal-value.v2.json',
  'lib/schema/canonical/contract-v2/serving-metric-operation-binding-inputs/seller-termination-fee-percent-of-deal-value.v2.json',
  ...
  'tests/canonical-v2-active-query-page.test.js',
  'tests/canonical-v2-agreement-candidate-domain-result-adapter.test.js',
  'tests/canonical-v2-agreement-candidate-envelope-contract-input.test.js',
  'tests/canonical-v2-agreement-candidate-envelope.test.js',
  ...
  'tests/canonical-v2-deal-scope-writer.test.js',
  'tests/canonical-v2-definition-occurrence-sql.test.js',
  'tests/canonical-v2-metsera-exclusivity-browser-acceptance.test.js',
  ...
  'tests/canonical-v2-metsera-exclusivity-product-source-reader.test.js',
  ...
  'tests/canonical-v2-persisted-canonical-object-resolution.test.js',
  'tests/canonical-v2-pilot-product-authority-context.test.js',
  ...
  'tests/canonical-v2-product-query-result-release-partition.test.js',
  'tests/canonical-v2-product-query-result-serving-record.test.js',
  ...
  'tests/canonical-v2-qxo-capitalisation-f28-candidate-envelope-contract-input.test.js',
  'tests/canonical-v2-qxo-capitalisation-f28-candidate-envelope.test.js',
  'tests/canonical-v2-qxo-capitalisation-f28-pilot-preflight.test.js',
  'tests/canonical-v2-qxo-capitalisation-f28-product-result-adapter-v2-contract-input.test.js',
  'tests/canonical-v2-qxo-capitalisation-f28-product-result-adapter-v2.test.js',
  'tests/canonical-v2-qxo-capitalisation-f28-product-surfaces.test.js',
  'tests/canonical-v2-qxo-capitalisation-f28-runtime-link.test.js',
  'tests/canonical-v2-qxo-capitalisation-f28-writer-link.test.js',
  'tests/canonical-v2-reviewed-ioc-capex-slice.test.js',
  'tests/canonical-v2-serving-client.test.js',
  'tests/canonical-v2-staging-agreement-product-writer-p8.test.js',
  'tests/canonical-v2-staging-p1-evidence-runner.test.js',
  'tests/canonical-v2-staging-product-query-cache-p8.test.js',
  'tests/canonical-v2-staging-schema-runner.test.js',
  'tests/canonical-v2-vertical-slice-attestation.test.js',
  ...
  'tests/g0-owner-authority-allowed-paths.test.js',
  'tests/programme-gates/architecture-gate-closure.spec.js',
  'tests/programme-gates/cold-review-tasks.spec.js',
  'tests/programme-gates/governing-registry.spec.js',
  'tests/programme-gates/isolation-evidence.spec.js',
  'tests/programme-gates/local-cold-review-runner.spec.js',
  'tests/programme-gates/local-review-controller-preflight.spec.js',
  'tests/programme-gates/m1-milestone-permission.spec.js',
