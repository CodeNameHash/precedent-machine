#!/usr/bin/env node
/**
 * Emit the KEY_DEFINED_TERMS Ben inventory disposition, session receipt, and the
 * three remaining Work3 successor authorities plus the family package seal receipt.
 *
 * Disposition is APPROVE on all 76 profiles with the subtype-grouping question
 * stamped as an open hold. Q01-Q03 reuse the sealed M5 programme rulings the family
 * role schema already binds; no KeyDefinedTerms-specific ruling is invented.
 */
import { readFileSync, writeFileSync } from 'node:fs';
import { join } from 'node:path';
import canonicalModule from '../lib/canonical-v2/canonical-bytes.js';
import keyDefinedTermsAuthoring from '../lib/canonical-v2/m7-v2-key-defined-terms-authoring.js';
...
const PACKET_PATH =
  `${CONTROL}/m7-v2-repair-key-defined-terms-76-profile-inventory-review-packet-draft.json`;
const INVENTORY_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-key-defined-terms-unapproved-inventory-review-authority.json`;
const DISPOSITION_PATH =
  `${CONTROL}/m7-v2-repair-key-defined-terms-76-profile-inventory-disposition.json`;
const SESSION_PATH =
  `${CONTROL}/m7-v2-repair-key-defined-terms-ben-inventory-session-receipt.json`;
const BEN_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-key-defined-terms-ben-inventory-session-successor-authority.json`;
const SEAL_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-key-defined-terms-family-package-seal-successor-authority.json`;
const SEAL_RECEIPT_PATH =
  `${CONTROL}/m7-v2-repair-key-defined-terms-family-package-seal-receipt.json`;
const REGISTRATION_AUTHORITY_PATH =
  `${CONTROL}/m7-v2-repair-contract-work3-key-defined-terms-registration-successor-authority.json`;
const RULINGS_PATH = `${CONTROL}/m5-programme-rulings.json`;
const ROLE_SCHEMA_PATH = `${CONTROL}/family-role-schemas/KEY_DEFINED_TERMS.json`;

const DISPOSITION_SCHEMA =
  'STAGE_2Y_M7_V2_KEY_DEFINED_TERMS_76_PROFILE_INVENTORY_DISPOSITION/V1';
const SESSION_SCHEMA =
  'STAGE_2Y_M7_V2_KEY_DEFINED_TERMS_BEN_INVENTORY_SESSION_RECEIPT/V1';
const BEN_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_KEY_DEFINED_TERMS_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY/V1';
const SEAL_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_KEY_DEFINED_TERMS_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY/V1';
const SEAL_RECEIPT_SCHEMA =
  'STAGE_2Y_M7_V2_KEY_DEFINED_TERMS_FAMILY_PACKAGE_SEAL_RECEIPT/V1';
const REGISTRATION_AUTHORITY_SCHEMA =
  'STAGE_2Y_M7_V2_REPAIR_CONTRACT_WORK3_KEY_DEFINED_TERMS_REGISTRATION_SUCCESSOR_AUTHORITY/V1';
const SEAL_CANDIDATE_SCHEMA =
  'M7_V2_KEY_DEFINED_TERMS_WORK3_FAMILY_PACKAGE_SEAL_CANDIDATE/V1';
const BEN_CANDIDATE_STATE =
  'BEN_76_PROFILE_INVENTORY_DISPOSITION_CAPTURED_PACKAGE_SEAL_NOT_RECORDED';
const SEAL_CANDIDATE_STATE =
  'BEN_KEY_DEFINED_TERMS_FAMILY_PACKAGE_SEAL_CAPTURED_REGISTRATION_NOT_RECORDED';
...
const inventoryAuthorityBinding = binding(
  ...
  inventoryAuthority,
  'work3_key_defined_terms_unapproved_inventory_review_authority_id',
);
...
const sessionUnsigned = {
  ...
  session_classification: 'KEY_DEFINED_TERMS_76_PROFILE_INVENTORY_BEN_REVIEW',
...
const benAuthority = authority(
  ...
  'work3_key_defined_terms_ben_inventory_session_successor_authority_id',
  {
    authority_classification:
      'WORK3_KEY_DEFINED_TERMS_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareKeyDefinedTermsWork3BenInventorySessionDisposition',
      exact_outer_input_keys: [
        'key_defined_termsWork3BenInventorySessionDispositionEvidence',
        'key_defined_termsPhase4ReviewInput',
      ],
    ...
    schema_review_candidate_contract: {
      schema_version:
        'M7_V2_KEY_DEFINED_TERMS_WORK3_BEN_INVENTORY_SESSION_DISPOSITION_CANDIDATE/V1',
...
const sealAuthority = authority(
  ...
  'work3_key_defined_terms_family_package_seal_successor_authority_id',
  {
    authority_classification: 'WORK3_KEY_DEFINED_TERMS_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareKeyDefinedTermsWork3FamilyPackageSeal',
      exact_outer_input_keys: [
        'key_defined_termsWork3FamilyPackageSealEvidence',
        'key_defined_termsPhase4ReviewInput',
      ],
      exact_successor_evidence_keys: [
        'work3KeyDefinedTermsUnapprovedInventoryReviewAuthority',
...
// Mirrors prepareKeyDefinedTermsWork3FamilyPackageSeal exactly; the test asserts
...
const sealReceiptUnsigned = {
  ...
  seal_classification: 'KEY_DEFINED_TERMS_WORK3_FAMILY_PACKAGE_SEAL',
  completion_state: 'COMPLETE',
  reviewer: 'BEN_GOODCHILD',
...
const sealReceipt = {
  ...sealReceiptUnsigned,
  key_defined_terms_family_package_seal_receipt_id:
...
const registrationAuthority = authority(
  ...
  'work3_key_defined_terms_registration_successor_authority_id',
  {
    authority_classification: 'WORK3_KEY_DEFINED_TERMS_REGISTRATION_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareKeyDefinedTermsWork3FamilyPackageRegistration',
      exact_outer_input_keys: [
        'key_defined_termsWork3FamilyPackageRegistrationEvidence',
        'key_defined_termsPhase4ReviewInput',
      ],
      exact_successor_evidence_keys: [
        'work3KeyDefinedTermsUnapprovedInventoryReviewAuthority',
    ...
    schema_review_candidate_contract: {
      schema_version: 'M7_V2_KEY_DEFINED_TERMS_WORK3_FAMILY_PACKAGE_REGISTRATION_CANDIDATE/V1',
      candidate_state:
