...
const DISPOSITION_PATH = `${CONTROL}/m7-v2-repair-guaranty-5-profile-inventory-disposition.json`;
const SESSION_PATH = `${CONTROL}/m7-v2-repair-guaranty-ben-inventory-session-receipt.json`;
...
const SEAL_RECEIPT_PATH =
  `${CONTROL}/m7-v2-repair-guaranty-financing-party-family-package-seal-receipt.json`;
...
const RULINGS_PATH = 'docs/codex-program/notes/GUARANTY-BEN-RULINGS-Q01-Q03-2026-08-24.md';
const DISPOSITION_SCHEMA =
  'STAGE_2Y_M7_V2_GUARANTY_FINANCING_PARTY_5_PROFILE_INVENTORY_DISPOSITION/V1';
const SESSION_SCHEMA =
  'STAGE_2Y_M7_V2_GUARANTY_FINANCING_PARTY_BEN_INVENTORY_SESSION_RECEIPT/V1';
...
const SEAL_RECEIPT_SCHEMA =
  'STAGE_2Y_M7_V2_GUARANTY_FINANCING_PARTY_FAMILY_PACKAGE_SEAL_RECEIPT/V1';
...
const SEAL_CANDIDATE_SCHEMA =
  'M7_V2_GUARANTY_FINANCING_PARTY_WORK3_FAMILY_PACKAGE_SEAL_CANDIDATE/V1';
...
const sessionUnsigned = {
  ...
  session_classification: 'GUARANTY_FINANCING_PARTY_5_PROFILE_INVENTORY_BEN_REVIEW',
...
const benAuthority = authority(
  ...
  'work3_guaranty_financing_party_ben_inventory_session_successor_authority_id',
  {
    authority_classification: 'WORK3_GUARANTY_FINANCING_PARTY_BEN_INVENTORY_SESSION_SUCCESSOR_AUTHORITY',
    authority_state:
    ...
    implementation_contract: {
      exported_function: 'prepareGuarantyFinancingPartyWork3BenInventorySessionDisposition',
    ...
    schema_review_candidate_contract: {
      schema_version:
        'M7_V2_GUARANTY_FINANCING_PARTY_WORK3_BEN_INVENTORY_SESSION_DISPOSITION_CANDIDATE/V1',
      candidate_state:
...
const reviewStampsBinding = {
  ...rulingsBinding,
  legal_grouping_status: 'PENDING_LEGAL_REVIEW',
  performance_guaranty_grouping_status: 'PENDING_LEGAL_REVIEW',
};
const sealAuthority = authority(
  SEAL_AUTHORITY_SCHEMA,
  'work3_guaranty_financing_party_family_package_seal_successor_authority_id',
  {
    authority_classification: 'WORK3_GUARANTY_FINANCING_PARTY_FAMILY_PACKAGE_SEAL_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareGuarantyFinancingPartyWork3FamilyPackageSeal',
      exact_outer_input_keys: [
    ...
    schema_review_candidate_contract: {
      ...
      candidate_state:
        'BEN_GUARANTY_FINANCING_PARTY_FAMILY_PACKAGE_SEAL_CAPTURED_REGISTRATION_NOT_RECORDED',
      review_accounting_exact_values: {
        inventory_review_count: 1,
...
const sealReceiptUnsigned = {
  ...
  seal_classification: 'GUARANTY_FINANCING_PARTY_WORK3_FAMILY_PACKAGE_SEAL',
  completion_state: 'COMPLETE',
  reviewer: 'BEN_GOODCHILD',
...
const sealReceipt = {
  ...sealReceiptUnsigned,
  guaranty_financing_party_family_package_seal_receipt_id:
...
const registrationAuthority = authority(
  ...
  'work3_guaranty_financing_party_registration_successor_authority_id',
  {
    authority_classification: 'WORK3_GUARANTY_FINANCING_PARTY_REGISTRATION_SUCCESSOR_AUTHORITY',
    ...
    implementation_contract: {
      exported_function: 'prepareGuarantyFinancingPartyWork3FamilyPackageRegistration',
      exact_outer_input_keys: [
    ...
    schema_review_candidate_contract: {
      schema_version: 'M7_V2_GUARANTY_FINANCING_PARTY_WORK3_FAMILY_PACKAGE_REGISTRATION_CANDIDATE/V1',
      candidate_state:
      ...
      review_accounting_exact_values: {
        ...
        profile_disposition_count: 5,
        profile_identity_count: 5,
        registration_count: 1,
        runtime_validator_acceptance_count: 1,
        work3_identity_count: 6,
      },
    },
    zero_effect_boundary: {
      activation_count: 0,
