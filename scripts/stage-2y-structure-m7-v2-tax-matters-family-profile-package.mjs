#!/usr/bin/env node
/**
 * Regenerate the on-disk TAX_MATTERS Work3 family profile package from the
...
const PACKAGE_PATH = `${CONTROL}/m7-v2-repair-family-work3-profile-package-tax-matters.json`;
const WORK3_AUTHORITY_PATH = `${CONTROL}/m7-v2-repair-contract-work3-entry-correction-authority.json`;

const FAMILY_KEY = 'TAX_MATTERS';
...
const APPROVAL_TEXT =
  'Ben approves the TAX_MATTERS 17-profile Work3 package inventory; subtype grouping '
  + 'review pending.';
...
function buildPhase4Review() {
  ...
  return taxMattersAuthoring.prepareTaxMattersFamilyProfilePackageReview({
    taxMattersAuthoringPhase4FamilyProfilePackageReviewAuthority:
      boundEnvelope(PHASE4_BINDING),
    taxMattersAuthoringPhase2Authority: phase2Authority,
