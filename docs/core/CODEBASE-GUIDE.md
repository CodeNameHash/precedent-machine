...
- `components/product/PublishedSummary.jsx`, `lib/product/published-layers.js`: reader view, headline first, click to descend. `tests/product-published-layers.test.js`.
