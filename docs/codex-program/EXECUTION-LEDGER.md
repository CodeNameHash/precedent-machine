...
| `PM-QXO-F28-CANDIDATE-01` | P8 | Add one immutable F28 candidate envelope for one row with 14 ordered metric terminals. | PM implementation | Same branch; commits `cec829c`, `a85832d`, `62f2586`, `f053660`, `01b8cd8` and `f8c1dd1`. | 15 envelope and adapter tests PASS. | COMPLETE | Preserve the envelope-bound Product result. | No |
...
1. Build the isolated QXO staging acceptance runner.
