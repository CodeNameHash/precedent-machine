...
| Active milestone branch | `codex/p8-combined-pilot-integration-v1`, substantive head `79ae3bdf`; includes the generic Agreement envelope, bounded PI pipeline connector, sealed Metsera source-to-sidecar run, signed Process result admission, shared Product row, Product result set and answer-first Product presentation |
