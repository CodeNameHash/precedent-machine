...
records are not rewritten. The release evaluator also currently requires every
citation to be marked narrow, whereas this plan lists narrowness as a diagnostic
and fixes exactness and legal sufficiency as the release bar. That mismatch has
not been changed or used to pass the candidate.
