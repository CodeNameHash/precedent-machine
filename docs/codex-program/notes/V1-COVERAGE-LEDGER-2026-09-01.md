...
| Threshold disposition for every governed restriction | The 113 sealed profiles record restriction presence and retain source clause text. They do not yet account for each threshold as source-backed typed value present, absent or unresolved. This omission is not evidence of absence. | `INTERIM_OPERATING` | `NOT_YET_MEASURED`; FAMILY-DEPTH EXTRACTION DEFERRED |
| Exception disposition for every governed restriction | The 113 sealed profiles record restriction presence and retain source clause text. They do not yet account for each exception as source-backed exception data present, absent or unresolved. This omission is not evidence of absence. | `INTERIM_OPERATING` | `NOT_YET_MEASURED`; FAMILY-DEPTH EXTRACTION DEFERRED |
