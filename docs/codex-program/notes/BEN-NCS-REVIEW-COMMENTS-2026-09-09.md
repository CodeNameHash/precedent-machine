...
## 10. Answers to the table-shapes note's twenty questions, 2026-09-13 01:00 UTC (verbatim, dictated)

"On your questions. So on one, this should be not a one step merger. It should be something like two sequential mergers or something like that. Maybe do Google for how people describe this transaction structure. For consideration, reverse triangular merger and forward triangular merger are different. You should do some research on what they are, and you should have a ability for the structure to understand which is which. Three, entitled, not entitled is correct. Um, sometimes it can earn into them if they're out of the money at the cash price. But if the milestone hits and the combination put them into the money, they can receive a spread above their exercise price and combined cash CVR number. Um, so you want to look for that. four. Yes. It should be brought down into one vocabulary. Well, I'm not showing them, like, putting down in closing condition. They're the same thing. Um, if you meant the standard of the rep, that could be different, but that's not the bring down. Five, it should be a relative time period. So in your example, three point three years, and then a mouse over should have the the date itself because then you can actually compare them. six no it's not always a mirror image list sometimes it's not um a parent definition this is not a company definition when they appear they're nearly always the same but maybe not necessarily seven. They can be different buckets, um, but that really comes down to the contract itself. Hey, I'm not really sure what the question is. Could you be clearer? Oh, nine. I'm not sure if they were empty. It should not... it's not a conscious emission. It's an error if it does. Ten, no. You should keep them separate as you suggest. eleven. I'm not sure of the question there. Sorry. Twenty. Now each row should have its own independent trigger set. thirteen I wouldn't include the x of y standard conditions. I don't think it's necessary or helpful. I'm not quite following fourteen. Can trend be a bit clearer? On fifteen, again, I'm not quite sure what you mean. Sorry. Twelve sixteen o degree, not specified, just means that there's nothing in the document. We can't find it. seventeen. They should carry any benefit elements that are in the deal. They shouldn't just write everything out. They need to be actually found in the deal itself. but they should be split out as per the table because sometimes they're combing bold in a draft. And so you wanna have a consistent reference that sort of this is trying to do. So you have to split out if it combines and you just split it out, etcetera. I think eighteen drives subject to anything else we find as we walk our way through things. Nineteen, we should just have a reference appendix. And we might wanna compare definitions between deals in the future, just not now. Um, oh, maybe now, but for example, you wanna see how law is defined in two different deals. twenty again or quite following the question. Sorry."

Assistant's reading (the "Twenty" before "each row should have its own independent trigger set" is taken as the answer to Q12, since Q12 is the trigger-set question and Q20 is answered separately as unclear): Q1 not "One Step Merger", two sequential mergers, research the usual name; Q2 reverse and forward triangular mergers are different and the structure must tell them apart; Q3 Entitled / Not entitled plus a value for out-of-the-money awards that earn in when a milestone puts them in the money (spread over exercise price on cash plus CVR); Q4 one bring-down vocabulary shared by the reps table and closing conditions, the rep's own qualifier standard stays separate; Q5 lookback as a relative period with the date on hover; Q6 parent and company carve-out lists are not forced to mirror; Q7 different buckets are possible, contract-driven; Q8 unclear, re-asked; Q9 an empty band is an error if the agreement has content, never a conscious omission; Q10 keep the four verbs separate; Q11 unclear, re-asked; Q12 each row has its own trigger set; Q13 drop the "x of y standard conditions" checklist; Q14 unclear, re-asked; Q15 unclear, re-asked; Q16 "Not specified" means nothing found in the document, not a third code; Q17 carry only benefit elements found in the deal, split combined elements into the table's rows; Q18 Yes / No / Silent stands, subject to later findings; Q19 defined terms are a reference appendix, cross-deal definition comparison later (possibly now, e.g. how "Law" is defined); Q20 unclear, re-asked.

Follow-up, 2026-09-13 01:10 UTC (verbatim): "8. yes separate / 11. one row is how it should work / 14. yes all detail / 15. either way is fine / 20. yes we should have those secitons"
