...
COMMENT ON COLUMN public.claims.canonical_numeric IS
  ...
  'ATTRIBUTES), shape { "value": <number>, "unit": "<USD|percent|'
  'elapsed_hours|calendar_days|business_days|months|years|shares>" }. NEVER '
  'fabricated: null means the '
