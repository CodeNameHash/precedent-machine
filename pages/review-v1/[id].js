...
export default function ReviewPage() {
  ...
  const headerConsiderationLabel = headlineConsiderationLabel(
    deriveHeadlineConsiderationType(provisions),
    provisions,
  ) || deal.consideration_type || 'Not specified';
  const hasReviewContent = schemaCardsLoading || schemaCardsError || schemaReviewDeal;
            ...
            <div style={{ marginBottom: 26 }}>
              ...
              {isEdit && (
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  />
                  <Link
                    href={`/review-v1/${dealId}/needs-review`}
