export default function QueueSidebar({ entries = [], selectedId, total = entries.length, onSelect }) {
  return (
    <aside className="border-r border-border bg-white p-3" data-testid="reconcile-queue">
      ...
      <p className="mt-1 text-xs text-inkLight">{entries.length} of {total}</p>
