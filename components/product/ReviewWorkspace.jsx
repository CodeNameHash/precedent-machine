...
export default function ReviewWorkspace({ runId }) {
  ...
  return <div className="mx-auto max-w-6xl space-y-6 pb-20">
    ...
    {state.status === 'PUBLISHED' ? <><AcceptedSummary summary={state.summary} metrics={state.metrics} onSource={openSource} active={candidateActive} /><ReleaseEvaluation state={state} analysis={workspace.analysis} referenceSources={workspace.reference_sources || []} busy={busy} onEvaluate={command} onSource={openSource} /></> : <>
